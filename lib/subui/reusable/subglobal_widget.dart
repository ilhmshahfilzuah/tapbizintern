...
class SubGlobalWidget {
  ...
  PreferredSizeWidget globalAppBar() {
    return AppBar(
      ...
      title: Row(
        ...
        children: [
          Image.asset('${AppSettings.AppLogoAppBar}', height: 40),
          Text(
  ...
  Widget createDetailWidgetTitle({required String title}) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget createDetailWidgetDes({required String desc}) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
