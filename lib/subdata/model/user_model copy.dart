...
class UserModel {
  ...
  late String _arkibBankisu;
  late String _arkibInfografik;
  ...
  String get arkibBankisu => _arkibBankisu;
  String get arkibInfografik => _arkibInfografik;
  ...
  set arkibBankisu(String newarkibBankisu) => this._arkibBankisu = newarkibBankisu;
  set arkibInfografik(String newarkibInfografik) => this._arkibInfografik = newarkibInfografik;
  ...
  UserModel.fromJson(Map<String, dynamic> rs) {
    ...
    this._arkibBankisu = rs['ArkibBankisu'].toString();
    this._arkibInfografik = rs['ArkibInfografik'].toString();
