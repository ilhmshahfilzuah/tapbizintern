...
import 'home_subAccSetChangePassword.dart';
        ...
        (AccSetQuery == 'Main Profile')
            ? Column(
                children: [
                  ...
                  // -----------
                  (userCls != null) ? PageAccSetMainProfile(parentQuery: 'Home', userQuery: '') : Container(),
                ],
              )
            : Container(),
            (AccSetQuery == 'Change Password')
            ? Column(
                children: [
                  // -----------
                  Column(
                  ...
                  // -----------
                  (userCls != null) ? PageAccSetChangePassword(parentQuery: 'Home', userQuery: '') : Container(),
                ],
              )
            : Container(),
