...
class PageSubGroups extends StatefulWidget {
  const PageSubGroups({Key? key, required this.dataSource, required this.dataId,required this.dataName,}) : super(key: key);
  final String dataSource;
  final String dataId;
  final String dataName;
  @override
  _PageSubGroupsState createState() => _PageSubGroupsState();
}

class _PageSubGroupsState extends State<PageSubGroups> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if(widget.dataSource!=''){
      userGroupidQuery=widget.dataId;
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(
                                                            'NFC Writing Tools - Delay Setting ',
