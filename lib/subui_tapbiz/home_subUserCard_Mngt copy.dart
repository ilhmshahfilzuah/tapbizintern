...
class _PageUserCard_MngtState extends State<PageUserCard_Mngt> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
                      ...
                      InkWell(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text('Share', style: TextStyle(color: (userQueryAction == 'Share') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Share') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                              ],
                            ),
                          ),
                        ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text((CardData == 'main') ? ' TapBiz Account' : ' Card'),
                      ],
                    ),
                    const Divider(
                      height: 20,
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  (User_Title != '') ? Text('$User_Title') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))
                                                ],
                                              ),
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                ...
                                                children: [
                                                  ...
                                                  (User_Dept != '') ? Text('$User_Dept') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))
                                                ],
                                              ),
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                ...
                                                children: [
                                                  ...
                                                  (User_Company != '') ? Text('$User_Company') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))
                                                ],
                                              ),
                                              Row(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                ...
                                                children: [
                                                  ...
                                                  (User_Headline != '') ? Text('$User_Headline') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))
                                                ],
                                              ),
                                              Text('----------'),
                                              Text(''),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [Text('Phone: ', style: TextStyle(fontWeight: FontWeight.bold)), (User_NoTel != '') ? Text('$User_NoTel') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))],
                                    ),
                                  ],
                                ),
                                Row(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.end,
                                      children: [Text('Email: ', style: TextStyle(fontWeight: FontWeight.bold)), (User_Email != '') ? Text('$User_Email') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))],
                                    ),
                                  ],
                                ),
                                SizedBox(height: 10),
                              ...
                              (AccSetQuery == 'Account & Card')
                                  ? Column(
                                      children: [
                                        ...
                                        Text('Pairing Email: $User_Email'),
                                        Text('Pairing Phone: $User_Email'),
                                        SizedBox(
                                          width: 200,
                                          child: const Divider(
                                            height: 20,
  ...
  Future<Null> _updateDb_UserDemo(String Username, String userQueryActionField, String dataObj, File? image) async {
    if (mounted) {
      setState(() {
        loading = true;
      });
          ...
          children: [
            (CardType == 'tapcard')
                ...
                Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      (userQueryActionField == null || userQueryActionField == 'User_Name' || userQueryActionField == 'User_Title' || userQueryActionField == 'User_Dept' || userQueryActionField == 'User_Company' || User_Telegram == 'User_Headline')
                          ? Text('INFORMATION')
                          : Container(),
                      // ---------
            ...
            (userQueryActionField == null || userQueryActionField == 'User_Telegram')
                ...
                : Container(),
            (userQueryActionField == null || userQueryActionField == 'User_Email')
                ? Card(
                    color: AppSettings.ColorUnderline2,
                    surfaceTintColor: AppSettings.ColorUnderline2,
                    elevation: 10,
