                                                    ...
                                                    children: [
                                                      Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text("Total Profile Allowed: $CardProfilePermission", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 12)),
                                                                                            ...
                                                                                            child: CircleAvatar(
                                                                                              ...
                                                                                              child: Hero(
                                                                                                ...
                                                                                                child: (this.listDb_UserDemoProfile[position].imageURL != '')
                                                                                                    ? ClipOval(
                                                                                                        child: buildCacheNetworkImage(width: 70, height: 70, url: '${this.listDb_UserDemoProfile[position].imageURL}'),
                                                                                                      )
                                                                                                    : Container(),
                                                                                              ),
                                                                                            ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.end,
                                      children: [Text('Email: ', style: TextStyle(fontWeight: FontWeight.bold)), (User_Mail != '') ? Text('$User_Mail') : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))],
                                    ),
                                  ],
                                ),
                                // SizedBox(height: 10),
