...
class _HomeSubMainPageState extends State<HomeSubMainPage> {
  ...
  void initState() {
    ...
    _menuDataSuperAdmin.add(CategoryModel(id: 2, name: 'Card Log', image: GLOBAL_URL + '/category/smartphone.png'));
    _menuDataSuperAdmin.add(CategoryModel(id: 3, name: 'Super Admin Setting', image: GLOBAL_URL + '/category/smartphone.png'));
                                                  ...
                                                  children: [
                                                    (userCls != null && userCls!.userAccess_Level != '1')
                                                        ...
                                                        : Column(
                                                            ...
                                                            crossAxisAlignment: CrossAxisAlignment.start,
                                                            children: [
                                                              Text("Super Admin Tools", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11)),
                                                              Column(
                                                                mainAxisAlignment: MainAxisAlignment.start,
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      InkWell(
                                                                        ...
                                                                        child:
                                                                            (PinNamaQuery == 'Superadmin') ? Text('# Super Admin', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11)) : Text("# Super Admin", style: TextStyle(fontSize: 11)),
                                                                      ),
                                                                      Text(" | "),
                                                                      InkWell(
                                                                        onTap: () async {
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              ' :${userCls!.userUser_Email} refvrfrvrevvveve',
                                              style: TextStyle(color: _color2, fontWeight: FontWeight.bold, fontSize: 12),
                                              maxLines: 2,
                                              overflow: TextOverflow.ellipsis,
                                            ),
                                        ...
                                        (userCls!.userAccess_Level == '1' || userCls!.userAccess_Level == '2' || userCls!.userAccess_Level == '3')
                                            ? Container()
                                            : Text(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      child: Hero(
                                        tag: 'profilePicture',
                                        child: (this.listDb_UserDemoAll[index].imageURL != '')
                                            ? ClipOval(
