...
class _PageUserCard_MngtState extends State<PageUserCard_Mngt> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    Text('', style: TextStyle(color: (userQueryAction == 'View') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'View') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                                    Text('', style: TextStyle(color: (userQueryAction == 'View') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'View') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                                  ],
                                ),
                              ],
                      ...
                      InkWell(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text('Card', style: TextStyle(color: (userQueryAction == 'Preview') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Preview') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                                Text('Preview', style: TextStyle(color: (userQueryAction == 'Preview') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Preview') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                              ],
                            ),
                          ),
                        ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Text('Rename Profile',
                                                style: TextStyle(
                                                    color: (userQueryAction == 'EditProfileName') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'EditProfileName') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                                          ],
                                        ),
                                      ),
                                    ),
                                      ...
                                      children: [
                                        ...
                                        Card(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: _updateAccountPairingForm(),
                                            ),
                                          ),
                                        ),
                                        SizedBox(
  ...
  Future<Null> _listThemeBlade_ByPersonal() async {
    if (mounted) {
      setState(() {
        loading = true;
      });
                  ...
                  child: ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text("Rename Profile Name", style: TextStyle(color: Colors.white, fontSize: 16.0, fontWeight: FontWeight.bold)),
                      ],
                    ),
                    onPressed: () {
  ...
  Widget _updateAccountPairingForm() {
    userQueryActionFieldName = 'User ID, Userrname, Email';
    userQueryActionField = 'CardProfileRename';
