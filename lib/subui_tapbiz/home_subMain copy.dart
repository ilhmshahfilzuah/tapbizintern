  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        //----------------------------------------------------1
        // (PinNamaQuery == '601myumno')
        //     ? _buildTop()
        //     : (PinNamaQuery == '602tadbirumno')
        //         ? _buildTop_tadbirumno()
        //         : _buildTop(),
        ...
        //                               onTap: () async {
        //                                 SharedPreferences prefs = await SharedPreferences.getInstance();
        //                                 prefs.setString('_menuMyumno', 'Info UMNO');
        //                                 setState(() {
        //                                   _menuMyumno = 'Info UMNO';
        //                                 });
        //                                 // Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //                               },
        //                               child: Card(
        //                                   elevation: 10,
        //                                   color: (_menuMyumno == 'Info UMNO') ? AppSettings.ColorMainGrey : Colors.white,
        //                                   child: Padding(
        //                                     padding: const EdgeInsets.all(4.0),
        //                                     child: Row(
        //                                       children: [
        ...
        //                                           size: 14,
        //                                         ),
        //                                         Text(' Info UMNO', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                                       ],
        //                                     ),
        //                                   )),
        //                             ),
        //                             Text(' ', style: TextStyle(color: _color2, fontWeight: FontWeight.bold)),
        //                             InkWell(
        //                               onTap: () async {
        //                                 // SharedPreferences prefs = await SharedPreferences.getInstance();
        //                                 // prefs.setString('_menuMyumno', 'Aktiviti');
        //                                 // setState(() {
        //                                 //   _menuMyumno = 'Aktiviti';
        //                                 // });
        //                                 Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => MyPageAktiviti()));
        //                               },
        //                               child: Card(
        //                                   elevation: 10,
        //                                   color: (_menuMyumno == 'Aktiviti') ? AppSettings.ColorMainGrey : Colors.white,
        //                                   child: Padding(
        //                                     padding: const EdgeInsets.all(4.0),
        //                                     child: Row(
        //                                       children: [
        //                                         Icon(
        //                                           Typicons.calendar_outlilne,
        //                                           size: 14,
        //                                         ),
        //                                         Text(' Aktiviti', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                                       ],
        //                                     ),
        //                                   )),
        //                             ),
        ...
        //                               onTap: () async {
        //                                 // SharedPreferences prefs = await SharedPreferences.getInstance();
        //                                 // prefs.setString('_menuMyumno', 'Garis Masa');
        //                                 // setState(() {
        //                                 //   _menuMyumno = 'Garis Masa';
        //                                 // });
        //                                 Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => MyPageTimeline()));
        //                               },
        //                               child: Card(
        //                                   elevation: 10,
        //                                   color: (_menuMyumno == 'Garis Masa') ? AppSettings.ColorMainGrey : Colors.white,
        //                                   child: Padding(
        //                                     padding: const EdgeInsets.all(4.0),
        //                                     child: Row(
        //                                       children: [
        ...
        //                                           size: 14,
        //                                         ),
        //                                         Text(' Garis Masa', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                                       ],
        //                                     ),
        //                                   )),
        //                             ),
        ...
        //                             //   onTap: () async {
        //                             //     SharedPreferences prefs = await SharedPreferences.getInstance();
        //                             //     prefs.setString('_menuMyumno', 'Notifikasi');
        //                             //     setState(() {
        //                             //       _menuMyumno = 'Notifikasi';
        //                             //     });
        //                             //     // Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //                             //   },
        //                             //   child: Card(
        //                             //     elevation: 10,
        //                             //       color: (_menuMyumno == 'Notifikasi') ? AppSettings.ColorMainGrey : Colors.white,
        //                             //       child: Padding(
        //                             //         padding: const EdgeInsets.all(4.0),
        //                             //         child: Text('Notifikasi', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                             //       )),
        //                             // ),
        //                             // Text(' ', style: TextStyle(color: _color2, fontWeight: FontWeight.bold)),
        //                             // InkWell(
        //                             //   onTap: () async {
        //                             //     SharedPreferences prefs = await SharedPreferences.getInstance();
        //                             //     prefs.setString('_menuMyumno', 'Profil');
        //                             //     setState(() {
        //                             //       _menuMyumno = 'Profil';
        //                             //     });
        //                             //     // Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //                             //   },
        //                             //   child: Container(
        //                             //       color: (_menuMyumno == 'Profil') ? AppSettings.ColorMainGrey : Colors.white,
        //                             //       child: Padding(
        //                             //         padding: const EdgeInsets.all(4.0),
        //                             //         child: Text('Profil', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                             //       )),
        //                             // ),
        //                           ],
        //                         ),
        ...
        //                               onTap: () async {
        //                                 SharedPreferences prefs = await SharedPreferences.getInstance();
        //                                 prefs.setString('_menuMyumno', 'Kaji Selidik');
        //                                 setState(() {
        //                                   _menuMyumno = 'Kaji Selidik';
        //                                 });
        //                                 // Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //                               },
        //                               child: Card(
        //                                   elevation: 10,
        //                                   color: (_menuMyumno == 'Kaji Selidik') ? AppSettings.ColorMainGrey : Colors.white,
        //                                   child: Padding(
        //                                     padding: const EdgeInsets.all(4.0),
        //                                     child: Row(
        //                                       children: [
        ...
        //                                           size: 14,
        //                                         ),
        //                                         Text(' Kaji Selidik', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                                       ],
        //                                     ),
        //                                   )),
        //                             ),
        ...
        //                               onTap: () async {
        //                                 SharedPreferences prefs = await SharedPreferences.getInstance();
        //                                 prefs.setString('_menuMyumno', 'Kempen & Gerak Kerja');
        //                                 setState(() {
        //                                   _menuMyumno = 'Kempen & Gerak Kerja';
        //                                 });
        //                                 // Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //                               },
        //                               child: Card(
        //                                   elevation: 10,
        //                                   color: (_menuMyumno == 'Kempen & Gerak Kerja') ? AppSettings.ColorMainGrey : Colors.white,
        //                                   child: Padding(
        //                                     padding: const EdgeInsets.all(4.0),
        //                                     child: Row(
        //                                       children: [
        ...
        //                                           size: 14,
        //                                         ),
        //                                         Text(' Kempen & Gerak Kerja', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                                       ],
        //                                     ),
        //                                   )),
        //                             ),
        ...
        //                       mainAxisAlignment: MainAxisAlignment.start,
        //                       children: [
        //                         Image.asset('${AppSettings.AppLogo}', height: 80),
        //                       ],
        //                     ),
        //                   ),
        //                 ),
        ...
        //                         },
        //                         child: Container(
        //                             color: (_menuMyumno == '') ? AppSettings.ColorMainGrey : Colors.white,
        //                             child: Padding(
        //                               padding: const EdgeInsets.all(4.0),
        //                               child: Text('[ Tutup ]', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 11)),
        //                             )),
        //                       ),
        //                     ],
        //                   ),
        //             (_menuMyumno == 'Info UMNO')
        //                 ? Row(
        //                     children: [Expanded(flex: 4, child: _createCategoryMenu())],
        //                   )
        //                 : Container(),
        //           ],
        //         ),
        ...
        // ),
        // // --------------
        // (_groupValue == 0) ? _MedSos_Slider('Isu-Isu Semasa', 'LL') : Container(),
        // (_groupValue == 1) ? _MedSos_Slider('Arkib Infografik', 'Infografik') : Container(),
        // (_groupValue == 2) ? _MedSos_Slider('Arkib Video', 'LL') : Container(),
        // (_groupValue == 3) ? _MedSos_Slider('Arkib Artikel', 'LL') : Container(),
        // // --------------
        // SizedBox(height: 25),
        // const Divider(
        //   height: 20,
        ...
        //   crossAxisAlignment: CrossAxisAlignment.center,
        //   children: [
        //     Text('Kandungan/Saluran Politik', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        //   ],
        // ),
        // SizedBox(height: 25),
        // _MedSos_Slider('', 'YouTube'),
        // SizedBox(height: 25),
        // _MedSos_Slider('', 'FB'),
        // SizedBox(height: 25),
        // _MedSos_Slider('', 'TikTok'),
        // SizedBox(height: 25),
        // _MedSos_Slider('Lain-Lain', 'LL'),
        // SizedBox(height: 25),
        // Column(
        //   children: [
        //     Container(
        ...
        //         children: [
        //           Text('Akrib Kandungan Politik', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        //           GestureDetector(
        //             onTap: () {
        ...
        // (PinNama=='602tadbirumno')?
        //     Row(
        //       children: [
        //         InkWell(
        //           onTap: () async {
        //             SharedPreferences prefs = await SharedPreferences.getInstance();
        //             prefs.setString('_modPengguna', 'Ahli');
        //             prefs.setString('PinNamaQuery', '601myumno');
        //             setState(() {
        //               _modPengguna = 'Ahli';
        //             });
        //             Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //           },
        //           child: Card(
        //             color: (_modPengguna=='Ahli')?Colors.grey:Colors.white,
        //               elevation: 10,
        //               child: Padding(
        ...
        //                     Text('Mod', style: TextStyle(color: _color2, fontWeight: FontWeight.bold, fontSize: 10)),
        //                     Text('Ahli', style: TextStyle(color: _color2, fontWeight: FontWeight.bold, fontSize: 10)),
        //                   ],
        //                 ),
        //               )),
        //         ),
        ...
        //           onTap: () async {
        //             SharedPreferences prefs = await SharedPreferences.getInstance();
        //             prefs.setString('_modPengguna', '');
        //             prefs.setString('PinNamaQuery', '602tadbirumno');
        //             setState(() {
        //               _modPengguna = '';
        //             });
        //             Navigator.pushReplacement(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex: 0)));
        //           },
        //           child: Card(
        //             color: (_modPengguna=='')?Colors.grey:Colors.white,
        //               elevation: 10,
        //               child: Padding(
        //                 padding: const EdgeInsets.all(2.0),
        //                 child: Column(
        ...
        //                     Icon(Icons.refresh_outlined),
        //                     Text('Mod', style: TextStyle(color: _color2, fontWeight: FontWeight.bold, fontSize: 10)),
        //                     Text('Tadbir', style: TextStyle(color: _color2, fontWeight: FontWeight.bold, fontSize: 10)),
        //                   ],
        //                 ),
        //               )),
        //         ),
