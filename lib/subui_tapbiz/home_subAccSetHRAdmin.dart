...
class PageAccSetHRAdmin extends StatefulWidget {
  @override
  _PageAccSetHRAdminState createState() => _PageAccSetHRAdminState();
}

class _PageAccSetHRAdminState extends State<PageAccSetHRAdmin> with SingleTickerProviderStateMixin {
  ...
  Widget _addForm() {
    userQueryActionFieldName = 'HR/Admin Verification Code';
