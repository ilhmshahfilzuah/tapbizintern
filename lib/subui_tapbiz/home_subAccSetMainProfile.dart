...
class PageAccSetMainProfile extends StatefulWidget {
  const PageAccSetMainProfile({Key? key, required this.parentQuery, required this.userQuery}) : super(key: key);
  final String parentQuery;
  final String userQuery;
  @override
  _PageAccSetMainProfileState createState() => _PageAccSetMainProfileState();
}

class _PageAccSetMainProfileState extends State<PageAccSetMainProfile> with SingleTickerProviderStateMixin {
      ...
      children: [
        Column(
          ...
          children: [
            ...
            // ---------
            (userQueryActionField == null || userQueryActionField == 'userUser_Name')
                ? Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: (userCls!.userUser_Name != '')
                                ? Row(
                                    children: [
                                      Text('NAME: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                      Expanded(child: Text('${userCls!.userUser_Name}')),
                                    ],
                                  )
                                : Text(
                                    'Enter Name',
                          ...
                          (userQueryActionField != null)
                              ...
                              : InkWell(
                                  onTap: () {
                                    setState(() {
                                      userQueryActionField = 'userUser_Name';
                                      userQueryActionFieldName = 'NAME';
                                      dataObjController.text = userCls!.userUser_Name;
                                      // -----------
                                      userQueryActionFieldURL = '';
                                      if (userCls!.userUser_Name != '') {
                ...
                : Container(),
            // ---------
            (userQueryActionField == null || userQueryActionField == 'userName')
                ? Card(
                    color: AppSettings.ColorUnderline2,
                    surfaceTintColor: AppSettings.ColorUnderline2,
                    elevation: 10,
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: (userCls!.userName != '')
                                ? Row(
                                    children: [
                                      Text('USERNAME: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                      Expanded(child: Text('${userCls!.userName}')),
                                    ],
                                  )
                                : Text(
                                    'Enter Username',
                          ...
                          (userQueryActionField != null)
                              ...
                              : InkWell(
                                  onTap: () {
                                    setState(() {
                                      userQueryActionField = 'userName';
                                      userQueryActionFieldName = 'USERNAME';
                                      dataObjController.text = userCls!.userName;
                                      // -----------
                                      userQueryActionFieldURL = '';
                                      if (userCls!.userName != '') {
                                        userCls!.userName = userCls!.userName.replaceAll(userQueryActionFieldURL!, '');
                                        dataObjController.text = userCls!.userName;
                                      }
                                      // -----------
                                    });
                ...
                : Container(),
            // ---------
            (userQueryActionField == null || userQueryActionField == 'userUser_Email')
                ? Card(
                    color: AppSettings.ColorUnderline2,
                    surfaceTintColor: AppSettings.ColorUnderline2,
                    elevation: 10,
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: (userCls!.userUser_Email != '')
                                ? Row(
                                    children: [
                                      Text('EMAIL: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                      Expanded(child: Text('${userCls!.userUser_Email}')),
                                    ],
                                  )
                                : Text(
                                    'Enter Email',
                          ...
                          (userQueryActionField != null)
                              ...
                              : InkWell(
                                  onTap: () {
                                    setState(() {
                                      userQueryActionField = 'userUser_Email';
                                      userQueryActionFieldName = 'EMAIL';
                                      dataObjController.text = userCls!.userUser_Email;
                                      // -----------
                                      userQueryActionFieldURL = '';
                                      if (userCls!.userUser_Email != '') {
                                        userCls!.userUser_Email = userCls!.userUser_Email.replaceAll(userQueryActionFieldURL!, '');
                                        dataObjController.text = userCls!.userUser_Email;
                                      }
                                      // -----------
                                    });
                ...
                : Container(),
            (userQueryActionField == null || userQueryActionField == 'userUser_NoTel')
                ? Card(
                    color: AppSettings.ColorUnderline2,
                    surfaceTintColor: AppSettings.ColorUnderline2,
                    elevation: 10,
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: (userCls!.userUser_NoTel != '')
                                ? Row(
                                    children: [
                                      Text('PHONE: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                      Expanded(child: Text('${userCls!.userUser_NoTel}')),
                                    ],
                                  )
                                : Text(
                                    'Enter Phone',
                          ...
                          (userQueryActionField != null)
                              ...
                              : InkWell(
                                  onTap: () {
                                    setState(() {
                                      userQueryActionField = 'userUser_NoTel';
                                      userQueryActionFieldName = 'PHONE';
                                      dataObjController.text = userCls!.userUser_NoTel;
                                      // -----------
                                      userQueryActionFieldURL = '';
                                      if (userCls!.userUser_NoTel != '') {
                                        // userCls!.userUser_NoTel = userCls!.userUser_NoTel.replaceAll(userQueryActionFieldURL!, '');
                                        dataObjController.text = userCls!.userUser_NoTel;
                                      }
                                      // -----------
                                    });
            ...
            // (userQueryActionField == null || userQueryActionField == 'userUser_Password')
            //     ? Card(
            //         color: AppSettings.ColorUnderline2,
            //         surfaceTintColor: AppSettings.ColorUnderline2,
            //         elevation: 10,
            ...
            //                       onTap: () {
            //                         setState(() {
            //                           userQueryActionField = 'userUser_Password';
            //                           userQueryActionFieldName = 'PASSWORD';
            //                           userQueryActionFieldName2 = 'RE-TYPE PASSWORD';
            //                           dataObjController.text = userCls!.userPassword;
            //                           // -----------
            //                           userQueryActionFieldURL = '';
            //                           if (userCls!.userPassword != '') {
            //                             userCls!.userPassword = userCls!.userPassword.replaceAll(userQueryActionFieldURL!, '');
            //                             dataObjController.text = userCls!.userPassword;
            //                           }
            //                           // -----------
            //                         });
            ...
            children: [
              ...
              (userQueryActionField == 'userUser_Password')
                  ? TextFormField(
                      // minLines: 1, //Normal textInputField will be displayed
                      // maxLines: 6, // when user presses enter it will adapt to it
                      controller: data2ObjController,
                      validator: (value) => value!.isEmpty ? 'Enter $userQueryActionFieldName2' : null,
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.all(8.0),
                        labelText: '$userQueryActionFieldName2',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(5.0),
                        ),
                      ),
