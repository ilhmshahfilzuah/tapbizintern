        ...
        child: Drawer(
          ...
          children: <Widget>[
            ...
            ListTile(
              title: InkWell(
                onTap: ()  {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage(tabIndex:3)));
                },
                child: Row(
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          '   More',
                          style: TextStyle(fontWeight: (_currentIndex == 3) ? FontWeight.bold : FontWeight.normal),
                        ),
                      ],
                    ),
                  ],
