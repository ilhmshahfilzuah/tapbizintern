...
class _PageGroupsState extends State<PageGroups> with SingleTickerProviderStateMixin {
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: listDb_CategoryGroup_DropdownMenuItem.map((DbCategoryCls map) {
                                  return DropdownMenuItem<String>(
                                    ...
                                    child: Container(
                                      color: (this.listDb_UserGroup_setState[position].GroupCategoryid == map.CategoryId) ? Colors.grey.shade300 : Colors.white,
                                      child: Padding(
                                          ...
                                          builder: (BuildContext context) => CupertinoAlertDialog(
                                            ...
                                            actions: <CupertinoDialogAction>[
                                              ...
                                              CupertinoDialogAction(
                                                child: Column(
                                                  children: [
                                                    Text('Yes',style: TextStyle(color: Colors.green.shade900),),
                                                    Text(
                                                ...
                                                isDestructiveAction: true,
                                                onPressed: () {
                                                  _updateDb_UserDemo(this.listDb_UserDemo_setState[position].Username, 'Groupid', userGroupidTransfer!, '', null, '', '').then((_) {
                                                    setState(() {
                                                      listDb_UserDemo=[];
                                                      listDb_UserDemo_setState=[];
                                              ...
                                              CupertinoDialogAction(
                                                child: Column(
                                                  children: [
                                                    Text('Yes',style: TextStyle(color: Colors.blue.shade900),),
                                                    Text(
            ...
            child: Column(
              ...
              children: [
                    ...
                    ? Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('GROUP CATEGORY: ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10)),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Expanded(
                ...
                (userQueryActionField == null || userQueryActionField == 'User_Name')
                    ...
                    : Container(),
                (userQueryActionField != null) ? _editGroupInfoForm('widget.userQuery'!) : Container(),
              ],
            ),
          ),
        ),
  ...
  Widget _editGroupInfoForm(String userQuery) {
