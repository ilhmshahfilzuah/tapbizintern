                            ...
                            ? Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: Card(
                                      surfaceTintColor: (userQueryAction == 'Rename Profile') ? Colors.grey.shade100 : AppSettings.ColorUnderline2,
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Column(
                                          children: [
                                            Text('Rename Profile',
                                                style: TextStyle(
                                                    color: (userQueryAction == 'Rename Profile') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Rename Profile') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                                          ],
                                        ),
                                      ),
                                    ),
                    ...
                    ? (AccSetQuery == null)
                        ...
                        : Column(
                            children: [
                              ...
                              // -------------------------Main Profile
                              // -------------------------Main Profile
                              (AccSetQuery == 'Account & Card - Pairing')
                                  ? Column(
                                      children: [
                                        SizedBox(
                                          width: 200,
