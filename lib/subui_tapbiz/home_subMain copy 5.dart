...
class _HomeSubMainPageState extends State<HomeSubMainPage> {
  ...
  void initState() {
    _getDb_UI();
    _menuDataSuperAdmin.add(CategoryModel(id: 1, name: 'Super Admin Setting', image: GLOBAL_URL + '/category/smartphone.png'));
    _menuDataSuperAdmin.add(CategoryModel(id: 2, name: 'Group Mngt', image: GLOBAL_URL + '/category/smartphone.png'));
