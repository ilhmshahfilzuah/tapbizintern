...
class _PageUserCard_MngtState extends State<PageUserCard_Mngt> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
              ...
              children: [
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        ...
                                        Text('Setting',
                                            style: TextStyle(color: (userQueryAction == 'Card Setting') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Card Setting') ? FontWeight.bold : FontWeight.normal, fontSize: 11)),
                                      ],
                                    ),
                                  ],
                                ),
                ...
                Column(
                  children: [
                                                                    ...
                                                                    ? InkWell(
                                                                        onTap: () async {
                                                                          setState(() {
                                                                            ...
                                                                            if (CardProfile != this.listDb_UserDemoProfile[position].ProfileName) {
                                                                              // _getDb_UserDemo_ProfileQuery
                                                                                            ...
                                                                                            builder: (BuildContext context) => CupertinoAlertDialog(
                                                                                              ...
                                                                                              actions: <CupertinoDialogAction>[
                                                                                                ...
                                                                                                CupertinoDialogAction(
                                                                                                  ...
                                                                                                  onPressed: () {
                                                                                                    // -------
                                                                                                    _delDb_UserDemoProfile(widget.userQuery, this.listDb_UserDemoProfile[position].ProfileName).then((_) {
                                                                                                      _getDb_UserDemo(widget.userQuery).then((_) {
                                                                                                        setState(() {
                                                                                                          // userQueryAction = 'View';
                                                                                                        });
                            ...
                            ? Column(
                                children: [
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Expanded(child: Text('  $CardProfileQuery   ', textAlign: TextAlign.center, style: TextStyle(fontSize: 14))),
                                    ],
                                  ),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                Text('Rename Profile',
                                                    style: TextStyle(
                                                        color: (userQueryAction == 'EditProfileName') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'EditProfileName') ? FontWeight.bold : FontWeight.normal, fontSize: 11)),
                                              ],
                                            ),
                                          ),
                                        ),
                    ...
                    (userQueryAction == 'AddProfileName')
                        ? Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 16.0, right: 16.0),
                                child: _addProfileNameForm(uuid, ''),
                              )
                            ],
                          )
                        : Container(),
                    ...
                    //                 crossAxisAlignment: CrossAxisAlignment.center,
                    //                 children: [
                    //                   Expanded(child: Text('  $CardProfile   ', textAlign: TextAlign.center, style: TextStyle(fontSize: 12))),
                    //                 ],
                    //               ),
                    //             ],
                    //           ),
                    (userQueryAction == 'EditProfileName')
                        ? Padding(
                            padding: const EdgeInsets.only(left: 16.0, right: 16.0),
                            child: _updateProfileNameForm(uuid, CardProfileidQuery.toString()),
                          )
                        : Container(),
                    // const Divider(
                    //   height: 20,
                                      ...
                                      children: [
                                        ...
                                        Card(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: _updateAccountPairingForm('$AccSetQuery'),
                                            ),
                                          ),
                                        ),
                                        SizedBox(
                                      ...
                                      children: [
                                        ...
                                        Card(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: _updateProfilePermissionSettingForm('$AccSetQuery'),
                                            ),
                                          ),
                                        ),
                                        SizedBox(
  ...
  Future<Null> _updateDb_UserDemo(String Username, String userQueryActionField, String dataObj, String flgdataObj, File? image, String Data1, String Data2) async {
    if (mounted) {
      setState(() {
        loading = true;
      });
  ...
  Future<Null> _updateDb_UserDemo_ProfileQuery(String Username, String CardProfileQuery, String userQueryActionField, String dataObj, String flgdataObj, File? image, String Data1, String Data2) async {
    if (mounted) {
      setState(() {
        loading = true;
      });
    ...
    // late var postdata;
    late String apiUrl;
    FormData postdata = FormData.fromMap({"Data1": Data1, "Data2": Data2, "Username": Username, "CardProfileQuery": CardProfileQuery, "nedField": userQueryActionField, "nedField_Data": dataObj, "nedField_Flg_Data": flgdataObj});
  ...
  Widget _AllThemeBlade(String userQuery) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                (BuildContext context, int index) {
                  return _buildItemThemeBlade(index, userQuery);
                },
  ...
  Widget _buildItemThemeBlade(index, userQuery) {
  ...
  Widget _editInformation(String userQuery) {
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    //------------EditDataProfile
                    onPressed: () {
                      _updateDb_UserDemo(userQuery, userQueryActionField!, dataObjFinal, flgdataObj, null, '', '');
                      userQueryActionField = null;
                    },
                  ),
                ),
  ...
  Widget _updateProfileNameForm(String uuid, String CardProfileidQuery) {
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      _updateDb_UserDemo(widget.userQuery, 'CardProfileRename', dataObj, '', null, uuid, CardProfileidQuery).then((_) {
                        _getDb_UserDemo(widget.userQuery).then((_) {
                          setState(() {
                            userQueryAction = 'View';
                          });
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      _addDb_UserDemoProfile(widget.userQuery).then((_) {
                        _getDb_UserDemo(widget.userQuery).then((_) {
                          setState(() {
                            userQueryAction = 'View';
                          });
  ...
  Widget _updateAccountPairingForm(String AccSetQuery) {
    // userQueryActionFieldName = 'User ID, Userrname, Email';
    // userQueryActionField = 'CardProfileRename';
  ...
  Widget _updateProfilePermissionSettingForm(String AccSetQuery) {
  ...
  // Widget _updateAccountEmailForm() {
  //   userQueryActionFieldName = 'User ID, Userrname, Email';
  //   userQueryActionField = 'CardProfileRename';
  //   // dataObjController.text = Email;
  ...
  //                         width: 4.0,
  //                       ),
  //                       Text("Update User ID", style: TextStyle(color: Colors.white, fontSize: 16.0, fontWeight: FontWeight.bold)),
  //                     ],
  //                   ),
  //                   onPressed: () {
  //                     _updateDb_UserDemo(widget.userQuery, 'Userid', dataObj, null, '', '').then((_) {
  //                       _getDb_UserDemo(widget.userQuery).then((_) {
  //                         setState(() {
  //                           userQueryAction = 'View';
  //                         });
  ...
  Future<Null> _addDb_UserDemoProfile(String Username) async {
    if (mounted) {
      setState(() {
        loading = true;
      });
  ...
  Future<Null> _delDb_UserDemoProfile(String Username, String ProfileName) async {
    if (mounted) {
      setState(() {
        loading = true;
      });
