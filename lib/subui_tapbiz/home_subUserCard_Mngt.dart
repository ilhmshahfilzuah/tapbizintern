...
class _PageUserCard_MngtState extends State<PageUserCard_Mngt> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  var loading = false;
  var loadingSubLayout = false;
  var loadingSubTheme = false;
  var _writeLoading = false;

  String CardProfile_collapse = 'Yes';

  bool _ValUser_Theme = false;
  ...
  String UserTapID_Age = '';
  String UserTapID_DOB = '';
  String UserTapID_Sex = '';
  String UserTapID_MaritalStatus = '';
  ...
  List<TapBizThemeModel> listDb_Theme_Query = [];
  ...
  Future<Null> _listThemeBlade_ByPersonal(String Username) async {
    ...
    postdata = {
      "Username": Username,
      "Access_Level": userCls!.userAccess_Level,
    ...
    if (response.statusCode == 200) {
      ...
      if (mounted) {
        setState(() {
          ...
          themeBlade = response.data['themeBlade'] ?? "bcard";
          themeURL = response.data['themeURL'] ?? "";
          themeCustomURL = response.data['themeCustomURL'] ?? "";

          User_Theme = response.data['User_Theme'] ?? 1;
          if (User_Theme == 0) {
            _ValUser_Theme = true;
          } else {
            _ValUser_Theme = false;
          }
          User_Title = response.data['User_Title'] ?? "";
          User_Dept = response.data['User_Dept'] ?? "";
          User_Company = response.data['User_Company'] ?? "";
    ...
    if (response.statusCode == 200) {
      ...
      if (mounted) {
        setState(() {
          ...
          User_Theme = response.data['User_Theme'] ?? "";
          User_Title = response.data['User_Title'] ?? "";
          User_Dept = response.data['User_Dept'] ?? "";
          User_Company = response.data['User_Company'] ?? "";
          User_Headline = response.data['User_Headline'] ?? "";
        ...
        : Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                (CardProfileQuery == '') ? SizedBox(height: 25) : Container(),
                (CardProfileQuery == '') ? ___profileList(profilePictureSize, boxImageSize) : Container(),
                ___profileMenu(),
      ...
      child: Row(
        children: [
          InkWell(
            ...
            child: Card(
              elevation: 10,
              surfaceTintColor: (userQueryAction == 'View' || userQueryAction == 'Edit' || userQueryAction == 'EditTapID' || userQueryAction == 'EditProfileName') ? Colors.grey.shade100 : AppSettings.ColorUnderline2,
              child: Padding(
                  ...
                  children: [
                    Column(
                      children: [
                        Icon(
                          Icons.home,
                          color: (userQueryAction == 'View' || userQueryAction == 'Edit' || userQueryAction == 'EditTapID') || userQueryAction == 'EditProfileName' ? AppSettings.ColorMain : Colors.black,
                        ),
                        Text('Main',
                            style: TextStyle(
                                color: (userQueryAction == 'View' || userQueryAction == 'Edit' || userQueryAction == 'EditTapID') || userQueryAction == 'EditProfileName' ? AppSettings.ColorMain : Colors.black,
                                fontWeight: (userQueryAction == 'View' || userQueryAction == 'Edit' || userQueryAction == 'EditTapID') || userQueryAction == 'EditProfileName' ? FontWeight.bold : FontWeight.normal,
                                fontSize: 11)),
                      ],
                    ),
                    Column(
  ...
  Widget ___profileList(double profilePictureSize, double boxImageSize) {
    return (userQueryAction == 'View' || userQueryAction == 'Edit' || userQueryAction == 'EditTapID' || userQueryAction == 'EditProfileName')
        ? Padding(
                                                            ...
                                                            children: [
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  //               child: Column(
                                                                  //                 children: [
                                                                  //                   Text('Default Profile', style: TextStyle(fontSize: 10)),
                                                                  //                 ],
                                                                  //               ),
                                                                  //             ),
                                                                  //           ),
                                                                      ...
                                                                      children: [
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            // Text(''),
                                                                            (this.listDb_UserDemoProfile[position].themeCustomURL == '' && this.listDb_UserDemoProfile[position].themeURL == '')
                                                                                ? Container()
                                                                                : (this.listDb_UserDemoProfile[position].User_Theme == 0)
                                                                                    ? Row(
                                                                                        children: [
                                                                                          Card(
                                                                                              ...
                                                                                              child: ClipRRect(
                                                                                                  ...
                                                                                                  child: buildCacheNetworkImage(width: boxImageSize * 35 / 100, url: this.listDb_UserDemoProfile[position].themeCustomURL))),
                                                                                        ],
                                                                                      )
                                                                                    : Row(
                                                                                        children: [
                                                                      ...
                                                                      ? InkWell(
                                                                          ...
                                                                          child: Card(
                                                                            ...
                                                                            child: Padding(
                                                                              ...
                                                                              child: Column(
                                                                                children: [
                                                                                  Text('Set Default Profile', style: TextStyle(fontSize: 10)),
                                                                                ],
                                                                              ),
                                                                            ),
                                                                          ),
  ...
  Widget ___profileMenu() {
    return Column(
      children: [
            ...
            : Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Expanded(child: Text('  $CardProfile   ', textAlign: TextAlign.center, style: TextStyle(color: AppSettings.ColorMain, fontSize: 16, fontWeight: FontWeight.bold))),
                    ],
                  ),
                  const Divider(
                    height: 20,
        ...
        (CardProfileQuery == '')
            ? Container()
            : (userQueryAction == 'View' || userQueryAction == 'Edit' || userQueryAction == 'EditTapID' || userQueryAction == 'EditProfileName')
                ? Column(
                    children: [
                      SizedBox(height: 40),
                      Row(
                        ...
                        children: [
                          Expanded(
                              child: (CardProfile == CardProfileQuery)
                                  ? Text('  $CardProfileQuery   ', textAlign: TextAlign.center, style: TextStyle(color: AppSettings.ColorMain, fontSize: 16, fontWeight: FontWeight.bold))
                                  : Text('  $CardProfileQuery   ', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold))),
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          Expanded(
                              child: (CardProfile == CardProfileQuery)
                                  ? Text('This Profile On Digital Card', textAlign: TextAlign.center, style: TextStyle(fontSize: 12))
                                  : Text('This Profile not the Default Profile On Digital Card', textAlign: TextAlign.center, style: TextStyle(fontSize: 12))),
                        ],
                      ),
                      SizedBox(height: 4),
                      Row(
                        ...
                        children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text('', style: TextStyle(color: (userQueryAction == 'View') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'View') ? FontWeight.bold : FontWeight.normal, fontSize: 11)),
                                  ],
                                ),
                              ),
                            ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text('Tap Card', style: TextStyle(color: (userQueryAction == 'Edit') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Edit') ? FontWeight.bold : FontWeight.normal, fontSize: 11)),
                                  ],
                                ),
                              ),
                            ),
                          ...
                          InkWell(
                            ...
                            child: Card(
                              elevation: 10,
                              surfaceTintColor: (userQueryAction == 'EditTapID') ? Colors.grey.shade100 : AppSettings.ColorUnderline2,
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Column(
                                  children: [
                                    Text('Edit', style: TextStyle(color: (userQueryAction == 'EditTapID') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'EditTapID') ? FontWeight.bold : FontWeight.normal, fontSize: 11)),
                                    Text('Tap ID', style: TextStyle(color: (userQueryAction == 'EditTapID') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'EditTapID') ? FontWeight.bold : FontWeight.normal, fontSize: 11)),
                                  ],
                                ),
                              ),
                            ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text('', style: TextStyle(color: (userQueryAction == 'Close') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Close') ? FontWeight.bold : FontWeight.bold, fontSize: 16)),
                                  ],
                                ),
                              ),
                            ),
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: boxImageSize * 20 / 100),
                                          (themeCustomURL == '')
                                              ? Container()
                                              : (User_Theme == 0)
                                                  ? Card(
                                                      surfaceTintColor: AppSettings.ColorUnderline2,
                                                      elevation: 20,
                                                      child: ClipRRect(borderRadius: BorderRadius.only(topLeft: Radius.circular(10), topRight: Radius.circular(10)), child: buildCacheNetworkImage(width: boxImageSize * 60 / 100, url: themeCustomURL)))
                                                  : Container(),
                                          (themeURL == '')
                                              ? Container()
                                              : (User_Theme == 1)
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    (User_Name != '') ? Expanded(child: Text('${User_Name.toUpperCase()}')) : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10))
                                                  ],
                                                ),
                                                SizedBox(height: 5),
                                                (User_Flg_Title != 1)
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              ...
                                                              (User_Title != '') ? Expanded(child: Text('${User_Title.toUpperCase()}')) : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10)),
                                                            ],
                                                          ),
                                                          SizedBox(height: 5),
                                                        ],
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              ...
                                                              (User_Dept != '') ? Expanded(child: Text('${User_Dept.toUpperCase()}')) : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10)),
                                                            ],
                                                          ),
                                                          SizedBox(height: 5),
                                                        ],
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              ...
                                                              (User_Company != '') ? Expanded(child: Text('${User_Company.toUpperCase()}')) : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10)),
                                                            ],
                                                          ),
                                                          SizedBox(height: 5),
                                                        ],
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              ...
                                                              (User_Headline != '') ? Expanded(child: Text('${User_Headline.toUpperCase()}')) : Text('Pls complete this field', style: TextStyle(color: Colors.red.shade300, fontSize: 10)),
                                                            ],
                                                          ),
                                                          SizedBox(height: 5),
                                                        ],
                                  ...
                                  child: Padding(
                                      ...
                                      child: // ----------------
                                        ...
                                        children: {
                                          ...
                                          2: Text('Files', style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontSize: 12)),
                                          // 3: Text('Others', style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontSize: 12)),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                      ...
                                      child: CupertinoSlidingSegmentedControl<int>(
                                        ...
                                        groupValue: _groupValue,
                                        children: {
                                          0: Text('Setting', style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontSize: 12)),
                                          1: Text('Tap ID - Local', style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontSize: 12)),
                                          2: Text('Tap ID - Foreigner', style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontSize: 12)),
                                        },
                                        onValueChanged: (groupValue) {
                                          print(groupValue);
                                          setState(() {
                                ...
                                (_groupValue == 0) ? _editProfileTapID(widget.userQuery, 'Setting') : Container(),
                                (_groupValue == 1) ? _editProfileTapID(widget.userQuery, 'Local') : Container(),
                                (_groupValue == 2) ? _editProfileTapID(widget.userQuery, 'Foreigner') : Container(),
                              ],
                            ),
                          ),
                        ),
  ...
  Widget _editProfileTapID(String userQuery, String UserTapID_Category) {
    final double profilePictureSize = MediaQuery.of(context).size.width / 4;
    return (UserTapID_Category == 'Setting')
        ? Column(
            children: [
              Text('Type of Tap ID? '),
              Row(children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Text('INFORMATION 3'),
                                      (userQueryActionField == null || userQueryActionField == 'UserTapID_Age')
                                          ? Card(
                                              color: AppSettings.ColorUnderline2,
                                              surfaceTintColor: AppSettings.ColorUnderline2,
                                              elevation: 10,
                                                  ...
                                                  children: <Widget>[
                                                      ...
                                                      child: (UserTapID_Age != '')
                                                          ? Row(
                                                              children: [
                                                                ...
                                                                Expanded(child: Text('$UserTapID_Age')),
                                                              ],
                                                            )
                                                          : Text(
                                                              'Enter AGE',
                                                    ...
                                                    (userQueryActionField != null)
                                                        ...
                                                        : InkWell(
                                                            onTap: () {
                                                              setState(() {
                                                                userQueryActionField = 'UserTapID_Age';
                                                                userQueryActionFieldName = 'AGE';
                                                                dataObjController.text = UserTapID_Age;
                                                                // -----------
                                                                userQueryActionFieldURL = '';
                                                                if (UserTapID_Age != '') {
                                                                  UserTapID_Age = UserTapID_Age.replaceAll(userQueryActionFieldURL!, '');
                                                                  dataObjController.text = UserTapID_Age;
                                                                }
                                                                // -----------
                                                              });
                                          ...
                                          : Container(),
                                      (userQueryActionField == null || userQueryActionField == 'UserTapID_DOB')
                                          ? Card(
                                              color: AppSettings.ColorUnderline2,
                                              surfaceTintColor: AppSettings.ColorUnderline2,
                                              elevation: 10,
                                                  ...
                                                  children: <Widget>[
                                                      ...
                                                      child: (UserTapID_DOB != '')
                                                          ? Row(
                                                              children: [
                                                                ...
                                                                Expanded(child: Text('$UserTapID_DOB')),
                                                              ],
                                                            )
                                                          : Text(
                                                              'Enter DOB',
                                                    ...
                                                    (userQueryActionField != null)
                                                        ...
                                                        : InkWell(
                                                            onTap: () {
                                                              setState(() {
                                                                userQueryActionField = 'UserTapID_DOB';
                                                                userQueryActionFieldName = 'DOB';
                                                                dataObjController.text = UserTapID_DOB;
                                                                // -----------
                                                                userQueryActionFieldURL = '';
                                                                if (UserTapID_DOB != '') {
                                                                  UserTapID_DOB = UserTapID_DOB.replaceAll(userQueryActionFieldURL!, '');
                                                                  dataObjController.text = UserTapID_DOB;
                                                                }
                                                                // -----------
                                                              });
                                          ...
                                          : Container(),
                                      (userQueryActionField == null || userQueryActionField == 'UserTapID_Sex')
                                          ? Card(
                                              color: AppSettings.ColorUnderline2,
                                              surfaceTintColor: AppSettings.ColorUnderline2,
                                              elevation: 10,
                                                  ...
                                                  children: <Widget>[
                                                      ...
                                                      child: (UserTapID_Sex != '')
                                                          ? Row(
                                                              children: [
                                                                ...
                                                                Expanded(child: Text('$UserTapID_Sex')),
                                                              ],
                                                            )
                                                          : Text(
                                                              'Enter SEX',
                                                    ...
                                                    (userQueryActionField != null)
                                                        ...
                                                        : InkWell(
                                                            onTap: () {
                                                              setState(() {
                                                                userQueryActionField = 'UserTapID_Sex';
                                                                userQueryActionFieldName = 'Sex';
                                                                dataObjController.text = UserTapID_Sex;
                                                                // -----------
                                                                userQueryActionFieldURL = '';
                                                                if (UserTapID_Sex != '') {
                                                                  UserTapID_Sex = UserTapID_Sex.replaceAll(userQueryActionFieldURL!, '');
                                                                  dataObjController.text = UserTapID_Sex;
                                                                }
                                                                // -----------
                                                              });
                                          ...
                                          : Container(),
                                      (userQueryActionField == null || userQueryActionField == 'UserTapID_MaritalStatus')
                                          ? Card(
                                              color: AppSettings.ColorUnderline2,
                                              surfaceTintColor: AppSettings.ColorUnderline2,
                                              elevation: 10,
                                              child: Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    Expanded(
                                                      child: (UserTapID_MaritalStatus != '')
                                                          ? Row(
                                                              children: [
                                                                Text('MARITAL STATUS: ', style: TextStyle(fontWeight: FontWeight.bold)),
                                                                Expanded(child: Text('$UserTapID_MaritalStatus')),
                                                              ],
                                                            )
                                                          : Text(
                                                    ...
                                                    (userQueryActionField != null)
                                                        ...
                                                        : InkWell(
                                                            onTap: () {
                                                              setState(() {
                                                                userQueryActionField = 'UserTapID_MaritalStatus';
                                                                userQueryActionFieldName = 'Marital Status';
                                                                dataObjController.text = UserTapID_MaritalStatus;
                                                                // -----------
                                                                userQueryActionFieldURL = '';
                                                                if (UserTapID_MaritalStatus != '') {
                                                                  UserTapID_MaritalStatus = UserTapID_MaritalStatus.replaceAll(userQueryActionFieldURL!, '');
                                                                  dataObjController.text = UserTapID_MaritalStatus;
                                                                }
                                                                // -----------
                                                              });
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Custom Theme?", style: TextStyle(fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ],
                        ),
                        ...
                        Transform.scale(
                          ...
                          child: CupertinoSwitch(
                            activeColor: AppSettings.ColorMain,
                            value: _ValUser_Theme!,
                            onChanged: (bool value) async {
                              setState(() {
                                _ValUser_Theme = value;
                                if (_ValUser_Theme == true) {
                                  User_Theme = 0;
                                } else {
                                  User_Theme = 1;
                                }
                                _updateDb_UserDemo_ProfileQuery(userQuery, 'User_Theme', User_Theme.toString(), '', null, uuid, CardProfileidQuery.toString(), CardProfileQuery);
                              });
                            },
                          ),
                        ),
                    ...
                    ? Column(
                        children: [
                          ...
                          (loadingSubTheme)
                              ...
                              : _editDisplay_Theme(userQuery, 'custom'),
                        ],
                      )
                    : Container(),
                (User_Theme == 1)
                    ? Column(
                        children: [
                          ...
                          (loadingSubTheme)
                              ...
                              : _editDisplay_Theme(userQuery, 'personal'),
                        ],
                      )
                    : Container(),
              ],
                                ...
                                builder: (BuildContext context) => CupertinoAlertDialog(
                                  ...
                                  actions: <CupertinoDialogAction>[
                                    ...
                                    CupertinoDialogAction(
                                      ...
                                      onPressed: () {
                                        // -------
                                        _updateDb_UserDemo_ProfileQuery(userQuery, 'themeBlade', listDb_ThemeBlade[index].ThemeBlade, '', null, uuid, CardProfileidQuery.toString(), CardProfileQuery);
                                        // -------
                                        Navigator.pop(context);
                                      },
                                    )
  ...
  Widget _editDisplay_Theme(String userQuery, String ThemeCat) {
    final double boxImageSize = ((MediaQuery.of(context).size.width) - 24) / 2 - 16;
    listDb_Theme_Query = (this.listDb_Theme.where((dblist) => dblist.ThemeCat == ThemeCat)).toList();
    String? themeURL_Field;
    String? themeURL_Data;

    if (ThemeCat == 'custom') {
      themeURL_Field = 'themeCustomURL';
      themeURL_Data = themeCustomURL;
      if (widget.parentQuery == 'Home') {
        listDb_Theme_Query = (this.listDb_Theme.where((dblist) => dblist.themeURL == themeURL_Data)).toList();
      }
    }
    if (ThemeCat == 'personal') {
      themeURL_Field = 'themeURL';
      themeURL_Data = themeURL;
    }
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate(
                (BuildContext context, int index) {
                  return Container(
                    child: Card(
                      ...
                      elevation: 2,
                      surfaceTintColor: (listDb_Theme_Query[index].themeURL != themeURL_Data) ? AppSettings.ColorUnderline2 : AppSettings.ColorMain,
                      child: GestureDetector(
                        behavior: HitTestBehavior.translucent,
                        onTap: () {
                          setState(() {
                            if (listDb_Theme_Query[index].themeURL != themeURL_Data) {
                              showCupertinoDialog<void>(
                                context: context,
                                builder: (BuildContext context) => CupertinoAlertDialog(
                                  ...
                                  actions: <CupertinoDialogAction>[
                                    ...
                                    CupertinoDialogAction(
                                      ...
                                      onPressed: () {
                                        // -------
                                        _updateDb_UserDemo_ProfileQuery(userQuery, themeURL_Field!, listDb_Theme_Query[index].themeURL, '', null, uuid, CardProfileidQuery.toString(), CardProfileQuery);
                                        // -------
                                        Navigator.pop(context);
                                      },
                                    )
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            (this.listDb_Theme_Query[index].themeURL == '')
                                ? ClipRRect(
                                ...
                                : ClipRRect(borderRadius: BorderRadius.only(topLeft: Radius.circular(10), topRight: Radius.circular(10)), child: buildCacheNetworkImage(width: boxImageSize, url: this.listDb_Theme_Query[index].themeURL)),
                            Container(
                              margin: EdgeInsets.fromLTRB(8, 8, 8, 8),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  (listDb_Theme_Query[index].themeURL == themeURL_Data) ? Icon(Typicons.ok, size: 16, color: _color1) : Icon(Typicons.download, size: 16, color: _color1),
                                  Text('  '),
                                  Expanded(
                                    child: Text(
                                      '${listDb_Theme_Query[index].ThemeName}',
                                      style: TextStyle(fontSize: 10, color: _color1),
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis,
                                    ),
                ...
                childCount: listDb_Theme_Query.length,
              ),
            ),
          ),
        ])
  ...
  Widget _viewCropImage(String data) {
    return CupertinoAlertDialog(
      title: Column(
        children: [
          Container(
