    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int position) {
        return InkWell(
          ...
          child: Card(
            elevation: 10,
            surfaceTintColor: (this.listDb_UserGroup[position].GroupCategory == 'Activated') ? AppSettings.ColorMain : AppSettings.ColorUnderline2,
            child: Padding(
              padding: const EdgeInsets.all(4.0),
              child: Column(
                children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Category: ${this.listDb_UserGroup[position].GroupCategory}',
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '      Activation Code: ${this.listDb_UserGroup[position].GroupActivationCode}',
                                  style: TextStyle(color: Colors.black, fontSize: 10),
                                ),
                              ],
                            ),
                      ...
                      InkWell(
                        ...
                        child: Card(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Typicons.edit, size: 12,color: Colors.green,),
                    ...
                    : Row(
                        ...
                        child: Card(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Typicons.loop, size: 12,color: Colors.green,),
                                  Text(' Transfer Card To Other Group', style: TextStyle(color: Colors.green, fontSize: 10)),
                                ],
                              ),
                            )),
                      ),
