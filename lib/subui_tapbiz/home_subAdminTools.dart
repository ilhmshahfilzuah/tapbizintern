...
class PageAdminTools extends StatefulWidget {
  @override
  _PageAdminToolsState createState() => _PageAdminToolsState();
}

class _PageAdminToolsState extends State<PageAdminTools> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Column(
          children: [
            ...
            // (_groupValue == 3) ? Container() : Container(),
