                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      // ),
                                      // Text('($CardProfileid)'),
                                      Text('  $CardProfile   ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                                  ...
                                  InkWell(
                                    ...
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Text('Close', style: TextStyle(color: (userQueryAction == 'Close') ? AppSettings.ColorMain : Colors.black, fontWeight: (userQueryAction == 'Close') ? FontWeight.bold : FontWeight.normal, fontSize: 12)),
                                          ],
                                        ),
                                      ),
                                    ),
