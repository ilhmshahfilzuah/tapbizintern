...
class _PageUserCard_MngtState extends State<PageUserCard_Mngt> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
              ...
              children: [
                ...
                (CardProfileQuery == '')
                    ...
                    : (userQueryAction == 'EditProfileName')
                        ? Padding(
                            padding: const EdgeInsets.only(left: 16.0, right: 16.0),
                            child: _editProfileNameForm(uuid, CardProfileidQuery.toString()),
                          )
                        : Container(),
                //---------------------------EditProfileName
                //---------------------------View
            ...
            child: Column(
              ...
              children: [
                ...
                (userQueryActionField == null || userQueryActionField == 'User_YouTube')
                    ...
                    : Container(),
                (userQueryActionField != null) ? _editInformation_TapId(widget.userQuery!) : Container(),
              ],
            ),
          ),
        ),
  ...
  Widget _editInformation_TapId(String userQuery) {
  ...
  Widget _editProfileNameForm(String uuid, String CardProfileidQuery) {
