                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text('USERS MNGT - TapBiz Registered Account', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                                    // Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int position) {
                return
                    ...
                    //   child: ListTile(
                    //     leading: Text(
                    //       this.listDb_ListDbUser[position].userUser_Email,
                    //     ),
                    //     trailing: Text(' ${this.listDb_ListDbUser[position].userData} ]')
                    //   ),
                    // );
                    // PageUsers_User
                    InkWell(
                  onTap: () async {
                    Navigator.push(context, new MaterialPageRoute(builder: (context) => PageUsers_User(dataSource: '', dataId: this.listDb_ListDbUser[position].userId, dataName: this.listDb_ListDbUser[position].userUser_Email)));
                  },
                  child: Card(
                    shadowColor: Colors.grey.shade300,
                    child: Padding(
          ...
          Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int position) {
                return InkWell(
                  onTap: () async {
                    Navigator.push(context, new MaterialPageRoute(builder: (context) => PageUsers_User(dataSource: '', dataId: this.listDb_DataUserSearch[position].userId, dataName: this.listDb_DataUserSearch[position].userUser_Email)));
                  },
                  child: Card(
                    shadowColor: Colors.grey.shade300,
                    child: Padding(
