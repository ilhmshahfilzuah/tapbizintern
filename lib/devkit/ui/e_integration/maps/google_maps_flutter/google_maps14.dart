...
import 'package:TapBiz/devkit/ui/e_integration/maps/google_maps_flutter/custom_image_assets.dart';
...
class _GoogleMaps14PageState extends State<GoogleMaps14Page> {
  ...
  Future<Null> _initImage() async {
    final ByteData dataElderly =
        await rootBundle.load('assets/devkit/images/facebook.png');
