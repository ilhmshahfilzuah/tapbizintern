...
class GoogleMaps5Page extends StatefulWidget {
  @override
  _GoogleMaps5PageState createState() => _GoogleMaps5PageState();
}

class _GoogleMaps5PageState extends State<GoogleMaps5Page> {
  ...
  void _setSourceAndDestinationIcons() async {
    _markerDirection = await BitmapDescriptor.fromAssetImage(
        ...
        'assets/devkit/images/direction.png');
  }
