      ...
      return Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text('Google Maps Property',
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                SwitchListTile(
                  ...
                  title: Text('Traffic', style: TextStyle(fontSize: 14)),
                  subtitle: Text('Enable / Disable Traffic',
                ...
                SwitchListTile(
                  contentPadding: EdgeInsets.all(0),
                  title: Text('Rotate', style: TextStyle(fontSize: 14)),
                  subtitle: Text('Enable / Disable Rotation',
                      style: TextStyle(fontSize: 14)),
                  value: _isRotate,
                  onChanged: (bool value) {
                    mystate(() {
                ...
                SwitchListTile(
                  contentPadding: EdgeInsets.all(0),
                  title: Text('Scroll', style: TextStyle(fontSize: 14)),
                  subtitle: Text('Enable / Disable Scroll',
                      style: TextStyle(fontSize: 14)),
                  value: _isScroll,
                  onChanged: (bool value) {
                    mystate(() {
                ...
                SwitchListTile(
                  contentPadding: EdgeInsets.all(0),
                  title: Text('Zoom Control', style: TextStyle(fontSize: 14)),
                  subtitle: Text('Enable / Disable Zoom Control',
                      style: TextStyle(fontSize: 14)),
                ...
                SwitchListTile(
                  contentPadding: EdgeInsets.all(0),
                  title: Text('Zoom Gesture', style: TextStyle(fontSize: 14)),
                  subtitle: Text('Enable / Disable Zoom Gesture',
                      style: TextStyle(fontSize: 14)),
