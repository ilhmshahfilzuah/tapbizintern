...
import 'package:TapBiz/devkit/config/apps/food_delivery/constant.dart';
        ...
        children: [
          Container(
            ...
            child: _globalWidget.createDetailWidget(
                ...
                desc:
                    'This is the example of google maps with geocoder. If you tap on the maps, the address will change according the latitude and longitude'),
          ),
          Expanded(
            child: Stack(
              children: [
          ...
          Container(
            margin: EdgeInsets.all(16),
            child: Text(_address == '' ? 'This is address text.' : _address,
                style: TextStyle(color: BLACK77, fontSize: 16)),
          ),
        ],
      ),
    );
