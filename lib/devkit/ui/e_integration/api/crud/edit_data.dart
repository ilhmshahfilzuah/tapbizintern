...
import 'package:TapBiz/devkit/bloc/student/bloc.dart';
import 'package:TapBiz/devkit/config/constant.dart';
import 'package:TapBiz/devkit/model/integration/student_model.dart';
...
class EditDataPage extends StatefulWidget {
  ...
  const EditDataPage({Key? key, this.index, required this.studentData})
      : super(key: key);
          ...
          child: ListView(
            ...
            children: [
              ...
              _globalWidget.createButton(
                  ...
                  onPressed: () {
                    _studentBloc.add(EditStudent(
                        sessionId: '5f0e6bfbafe255.00218389',
                        index: widget.index,
                        studentId: widget.studentData.studentId,
                        studentName: _etStudentName.text,
                        studentPhoneNumber: _etStudentPhoneNumber.text,
                        studentGender: _isSelectGender[0] ? 'male' : 'female',
                        studentAddress: _etStudentAddress.text,
                        apiToken: apiToken));
                  }),
            ],
          ),
