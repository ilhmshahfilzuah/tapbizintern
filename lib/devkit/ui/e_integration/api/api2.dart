...
import 'package:TapBiz/devkit/bloc/example/bloc.dart';
          ...
          children: [
            Container(
              child: _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of get data from API using POST Method'),
            ),
            Container(
              child: _globalWidget.createButton(
                  ...
                  onPressed: () {
                    _exampleBloc
                        .add(PostExample(id: '326548', apiToken: apiToken));
                  }),
            ),
            Container(
