...
import 'package:TapBiz/devkit/bloc/product_grid/bloc.dart';
import 'package:TapBiz/devkit/model/integration/product_grid_model.dart';
...
class _ProductGridPageState extends State<ProductGridPage> {
  ...
  void initState() {
    ...
    _productGridBloc.add(GetProductGrid(
            ...
            IconButton(
                ...
                onPressed: () {
                  Fluttertoast.showToast(
                      msg: 'Click Search', toastLength: Toast.LENGTH_LONG);
                }),
          ],
            ...
            children: <Widget>[
              ClipRRect(
                  ...
                  child: buildCacheNetworkImage(
                      width: boxImageSize,
                      height: boxImageSize,
                      url: productGridData[index].image)),
              Container(
                          ...
                          Text(
                              '\$ ' +
                                  _globalFunction.removeDecimalZeroFormat(
                                      productGridData[index].price),
                              style: TextStyle(
                                  fontSize: 13, fontWeight: FontWeight.bold)),
                          Text(productGridData[index].sale.toString() + ' Sale',
                              style: TextStyle(
                      ...
                      child: Row(
                        children: [
                          _globalWidget.createRatingBar(
                              rating: productGridData[index].rating, size: 12),
                          Text(
                              '(' +
