...
import 'package:TapBiz/devkit/bloc/authentication/login/login_bloc.dart';
import 'package:TapBiz/devkit/ui/e_integration/api/login_module/login_data.dart';
        ...
        listener: (context, state) {
          ...
          if (state is LoginSuccess) {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        LoginDataPage(loginData: state.loginData[0])));
          }
        },
            ...
            children: [
              Container(
                child: _globalWidget.createDetailWidget(
                    title: 'Login Module',
                    desc:
                        'This is the example of Login Module. Login Module is integrated with MySQL Database. Use email and password from MySQL.\n\n'
                        'Default Data\n'
