import 'package:TapBiz/devkit/config/static.dart';
...
class _LocalNotification3PageState extends State<LocalNotification3Page> {
  ...
  Future showNotification() async {
    ...
    String notifMessage =
        'this message will change if you expand this notification';
    ...
    var bigPictureStyleInformation = BigPictureStyleInformation(
      ...
      summaryText:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tortor tortor, ultrices id scelerisque a, elementum id elit. Maecenas feugiat tellus sed augue malesuada, id tempus ex sodales.',
    );
    ...
    await StaticVarMethod.flutterLocalNotificationsPlugin.show(
        3, notifTitle, notifMessage, platformChannelSpecifics,
          ...
          children: [
            Container(
              child: _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of local notification using Big Picture'),
            ),
            Container(
