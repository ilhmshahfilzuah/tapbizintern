        ...
        floatingActionButton: FabCircularMenu(
            ...
            children: <Widget>[
              IconButton(
                  ...
                  onPressed: () {
                    Fluttertoast.showToast(
                        msg: 'Home Pressed', toastLength: Toast.LENGTH_SHORT);
                  }),
              IconButton(
                  icon: Icon(Icons.add, color: Colors.white),
                  onPressed: () {
                    Fluttertoast.showToast(
                        msg: 'Add Pressed', toastLength: Toast.LENGTH_SHORT);
                  }),
              IconButton(
                  icon: Icon(Icons.edit, color: Colors.white),
                  onPressed: () {
                    Fluttertoast.showToast(
                        msg: 'Edit Pressed', toastLength: Toast.LENGTH_SHORT);
                  }),
              IconButton(
              ...
              IconButton(
                  ...
                  onPressed: () {
                    Fluttertoast.showToast(
                        msg: 'Camera Pressed', toastLength: Toast.LENGTH_SHORT);
                  }),
              IconButton(
                  icon: Icon(Icons.photo, color: Colors.white),
                  onPressed: () {
                    Fluttertoast.showToast(
                        msg: 'Photo Pressed', toastLength: Toast.LENGTH_SHORT);
                  }),
            ]));
  }
}
