...
import 'package:TapBiz/devkit/ui/b_widget/card/border_radius_card.dart';
import 'package:TapBiz/devkit/ui/b_widget/card/elevation_card.dart';
import 'package:TapBiz/devkit/ui/b_widget/card/shadow_color_card.dart';
import 'package:TapBiz/devkit/ui/b_widget/card/standart_card.dart';
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Standart Card',
                page: StandartCardPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Border Radius Card',
                page: BorderRadiusCardPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Elevation Card',
                page: ElevationCardPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Shadow Color Card',
                page: ShadowColorCardPage()),
          ],
        ));
  }
}
