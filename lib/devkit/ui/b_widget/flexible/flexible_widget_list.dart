...
import 'package:TapBiz/devkit/ui/b_widget/flexible/flexible_column.dart';
import 'package:TapBiz/devkit/ui/b_widget/flexible/flexible_row.dart';
        ...
        body: ListView(
          ...
          children: [
                ...
                children: [
                  ...
                  Flexible(
                      ...
                      child: Container(
                          alignment: Alignment.center,
                          child:
                              Icon(Icons.view_day, size: 40, color: SOFT_BLUE)))
                ],
              ),
            ),
            Container(
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Flexible Row',
                page: FlexibleRowPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Flexible Column',
                page: FlexibleColumnPage()),
          ],
        ));
  }
}
