          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget2(
                  ...
                  desc:
                      'Positioned Widget only used when it wrapped with Stack Widget.',
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    Positioned(left: 0, top: 0, child: Icon(Icons.email)),
                    Positioned(
                        right: 0, top: 0, child: Icon(Icons.directions_car)),
                    Positioned(
                        left: 0, bottom: 0, child: Icon(Icons.directions_boat)),
                    Positioned(
                        right: 0, bottom: 0, child: Icon(Icons.motorcycle)),
                    Positioned(
                        top: 0,
                        left: 40,
                        bottom: 0,
