...
fonts:
    - family: Audiowide-Regular
      fonts:
        - asset: assets/devkit/google_fonts/Audiowide-Regular.ttf

If you used font from google font, please add below code in the main.dart
LicenseRegistry.addLicense(() async* {
  final license = await rootBundle.loadString('assets/devkit/google_fonts/OFL.txt');
  yield LicenseEntryWithLineBreaks(['assets/devkit/google_fonts'], license);
});
 */
        ...
        body: ListView(
          ...
          children: [
            _globalWidget.createDetailWidget(
                ...
                desc:
                    'This is the example of text with font family and use different method (local font, local google font, google font from package)'),
