...
class BottomsheetDragdownToDismissPage extends StatefulWidget {
  @override
  _BottomsheetDragdownToDismissPageState createState() =>
      _BottomsheetDragdownToDismissPageState();
}

class _BottomsheetDragdownToDismissPageState
    extends State<BottomsheetDragdownToDismissPage> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of BottomSheet and must be dragdown or press back to dismiss'),
              Container(
