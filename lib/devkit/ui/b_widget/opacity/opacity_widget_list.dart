...
import 'package:TapBiz/devkit/ui/b_widget/opacity/image_opacity.dart';
import 'package:TapBiz/devkit/ui/b_widget/opacity/text_opacity.dart';
import 'package:flutter/material.dart';

class OpacityWidgetListPage extends StatefulWidget {
  @override
  _OpacityWidgetListPageState createState() => _OpacityWidgetListPageState();
}
        ...
        body: ListView(
          ...
          children: [
                ...
                children: [
                  ...
                  Flexible(
                      ...
                      child: Container(
                          ...
                          child:
                              Icon(Icons.opacity, size: 50, color: SOFT_BLUE)))
                ],
              ),
            ),
            Container(
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Text Opacity',
                page: TextOpacityPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Image Opacity',
                page: ImageOpacityPage()),
          ],
        ));
  }
}
