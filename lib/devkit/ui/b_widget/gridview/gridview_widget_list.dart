...
import 'package:TapBiz/devkit/ui/b_widget/gridview/gridview_height.dart';
import 'package:TapBiz/devkit/ui/b_widget/gridview/gridview_with_builder.dart';
import 'package:TapBiz/devkit/ui/b_widget/gridview/gridview_with_count.dart';
import 'package:TapBiz/devkit/ui/b_widget/gridview/gridview_with_extent.dart';
        ...
        body: ListView(
          ...
          children: [
                ...
                children: [
                  ...
                  Flexible(
                      ...
                      child: Container(
                          ...
                          child:
                              Icon(Icons.grid_on, size: 50, color: SOFT_BLUE)))
                ],
              ),
            ),
            Container(
            ...
            _globalWidget.screenDetailList(
                ...
                page: GridviewWithCountPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'GridView with builder',
                page: GridviewWithBuilderPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'GridView with extent',
                page: GridviewWithExtentPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'GridView height',
                page: GridviewHeightPage()),
          ],
        ));
  }
}
