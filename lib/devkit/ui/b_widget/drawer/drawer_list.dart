...
import 'package:TapBiz/devkit/ui/b_widget/drawer/drawer_custom_header.dart';
import 'package:TapBiz/devkit/ui/b_widget/drawer/drawer_custom_shape.dart';
import 'package:TapBiz/devkit/ui/b_widget/drawer/drawer_right.dart';
import 'package:TapBiz/devkit/ui/b_widget/drawer/standart_drawer.dart';
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                ...
                page: StandartDrawerPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Drawer at the right',
                page: DrawerRightPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Drawer Custom Header',
                page: DrawerCustomHeaderPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Drawer Custom Shape',
                page: DrawerCustomShapePage()),
          ],
        ));
  }
}
