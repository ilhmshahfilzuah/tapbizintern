...
import 'package:TapBiz/devkit/ui/b_widget/icon/icon_button.dart';
import 'package:TapBiz/devkit/ui/b_widget/icon/standart_icon.dart';
        ...
        body: ListView(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Flexible(
                      flex: 5,
                      child: Container(
                        child: Text('Icon Widget used to draw icon.',
                            style: TextStyle(
                                fontSize: 15,
                                color: BLACK77,
                                letterSpacing: 0.5)),
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Standart Icon',
                page: StandartIconPage()),
            _globalWidget.screenDetailList(
                context: context, title: 'Icon Button', page: IconButtonPage()),
          ],
        ));
  }
}
