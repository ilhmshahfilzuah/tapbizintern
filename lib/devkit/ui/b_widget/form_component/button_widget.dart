          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('FlatButton is deprecated, use TextButton instead',
                    ...
                    child: Ink(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: <Color>[Color(0xFF0D47A1), Color(0xFF42A5F5)],
                        ),
                ...
                Text('OutlineButton is deprecated, use OutlinedButton instead',
                    style: TextStyle(color: Colors.grey)),
                Container(
                  margin: EdgeInsets.symmetric(vertical: 8),
                ...
                Container(
                  margin: EdgeInsets.only(top: 20),
                  child:
                      Text('Outline Button with border color and text color'),
                ),
                Text('OutlineButton is deprecated, use OutlinedButton instead',
                    style: TextStyle(color: Colors.grey)),
                Container(
                ...
                Text('RaisedButton is deprecated, use ElevatedButton instead',
                    style: TextStyle(color: Colors.grey)),
                Container(
                  margin: EdgeInsets.symmetric(vertical: 8),
