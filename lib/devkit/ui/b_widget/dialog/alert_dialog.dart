  ...
  void _showPopup1() {
    ...
    Widget cancelButton = TextButton(
        onPressed: () {
          ...
          Fluttertoast.showToast(
              msg: 'Press No', toastLength: Toast.LENGTH_SHORT);
        },
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          Navigator.pop(context);
          Fluttertoast.showToast(
              msg: 'Press Yes', toastLength: Toast.LENGTH_SHORT);
        },
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
          ...
          style: TextStyle(fontSize: 13, color: BLACK21)),
      actions: [
        cancelButton,
        continueButton,
      ],
  ...
  void _showPopup2() {
    ...
    Widget signinFacebook = TextButton(
        onPressed: () {
          Navigator.pop(context);
          Fluttertoast.showToast(
              msg: 'Signin with Facebook', toastLength: Toast.LENGTH_SHORT);
        },
        child:
            Text('Signin with Facebook', style: TextStyle(color: SOFT_BLUE)));
    Widget signinTwitter = TextButton(
        onPressed: () {
          Navigator.pop(context);
          Fluttertoast.showToast(
              msg: 'Signin with Twitter', toastLength: Toast.LENGTH_SHORT);
        },
    ...
    Widget signinGoogle = TextButton(
        onPressed: () {
          Navigator.pop(context);
          Fluttertoast.showToast(
              msg: 'Signin with Google', toastLength: Toast.LENGTH_SHORT);
        },
  ...
  void _showPopup3() {
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          Navigator.pop(context);
          Fluttertoast.showToast(
              msg: 'Press Submit', toastLength: Toast.LENGTH_SHORT);
        },
