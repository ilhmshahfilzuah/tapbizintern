...
class HorizontalAlignmentColumnPage extends StatefulWidget {
  @override
  _HorizontalAlignmentColumnPageState createState() =>
      _HorizontalAlignmentColumnPageState();
}

class _HorizontalAlignmentColumnPageState
    extends State<HorizontalAlignmentColumnPage> {
        ...
        body: ListView(
          ...
          children: [
            _globalWidget.createDetailWidget(
                ...
                desc:
                    'This is the example of horizontal alignment in Column Widget'),
            Container(
                margin: EdgeInsets.only(top: 10), child: Text('Align left')),
            Container(
              height: 200,
            ...
            Container(
                margin: EdgeInsets.only(top: 20), child: Text('Align center')),
            Container(
              height: 200,
              margin: EdgeInsets.symmetric(vertical: 8),
              child: Container(
            ...
            Container(
                margin: EdgeInsets.only(top: 20), child: Text('Align right')),
            Container(
              height: 200,
              margin: EdgeInsets.symmetric(vertical: 8),
              child: Container(
