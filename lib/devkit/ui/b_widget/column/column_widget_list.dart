...
import 'package:TapBiz/devkit/ui/b_widget/column/horizontal_alignment_column.dart';
import 'package:TapBiz/devkit/ui/b_widget/column/standart_column.dart';
import 'package:TapBiz/devkit/ui/b_widget/column/vertical_alignment_column.dart';
import 'package:TapBiz/devkit/ui/b_widget/column/vertical_with_space_column.dart';
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                ...
                page: StandartColumnPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Horizontal Alignment',
                page: HorizontalAlignmentColumnPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Vertical Alignment',
                page: VerticalAlignmentColumnPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Vertical with Space',
                page: VerticalWithSpaceColumnPage()),
          ],
        ));
  }
}
