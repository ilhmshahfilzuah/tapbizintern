...
class HorizontalAlignmentRowPage extends StatefulWidget {
  @override
  _HorizontalAlignmentRowPageState createState() =>
      _HorizontalAlignmentRowPageState();
}

class _HorizontalAlignmentRowPageState
    extends State<HorizontalAlignmentRowPage> {
        ...
        body: ListView(
          ...
          children: [
            _globalWidget.createDetailWidget(
                ...
                desc:
                    'This is the example of horizontal alignment in Row Widget'),
            Container(
