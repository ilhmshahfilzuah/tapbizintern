...
import 'package:TapBiz/devkit/ui/b_widget/row/horizontal_alignment_row.dart';
import 'package:TapBiz/devkit/ui/b_widget/row/horizontal_with_space_row.dart';
import 'package:TapBiz/devkit/ui/b_widget/row/standart_row.dart';
import 'package:TapBiz/devkit/ui/b_widget/row/vertical_alignment_row.dart';
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Standart Row',
                page: StandartRowPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Horizontal Alignment',
                page: HorizontalAlignmentRowPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Horizontal with Space',
                page: HorizontalWithSpaceRowPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Vertical Alignment',
                page: VerticalAlignmentRowPage()),
          ],
        ));
  }
}
