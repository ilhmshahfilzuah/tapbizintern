...
class HorizontalWithSpaceRowPage extends StatefulWidget {
  @override
  _HorizontalWithSpaceRowPageState createState() =>
      _HorizontalWithSpaceRowPageState();
}

class _HorizontalWithSpaceRowPageState
    extends State<HorizontalWithSpaceRowPage> {
        ...
        body: ListView(
          ...
          children: [
            _globalWidget.createDetailWidget(
                ...
                desc:
                    'This is the example of horizontal with space in Row Widget'),
            Container(
                margin: EdgeInsets.only(top: 10),
                child: Text(
                    'Align center & give same space left right at all container')),
            Container(
