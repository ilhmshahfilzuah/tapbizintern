...
import 'package:TapBiz/devkit/ui/b_widget/sliver/sliver_appbar1.dart';
import 'package:TapBiz/devkit/ui/b_widget/sliver/sliver_appbar2.dart';
import 'package:flutter/material.dart';

class SliverAppbarListPage extends StatefulWidget {
  @override
  _SliverAppbarListPageState createState() => _SliverAppbarListPageState();
}
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Example 1',
                page: SliverAppbar1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Example 2',
                page: SliverAppbar2Page()),
          ],
        ));
  }
}
