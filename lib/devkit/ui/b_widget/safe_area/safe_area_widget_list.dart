...
import 'package:TapBiz/devkit/ui/b_widget/safe_area/setting_side_safe_area.dart';
import 'package:TapBiz/devkit/ui/b_widget/safe_area/with_safe_area.dart';
import 'package:TapBiz/devkit/ui/b_widget/safe_area/without_safe_area.dart';
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                ...
                page: WithoutSafeAreaPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'With Safe Area',
                page: WithSafeAreaPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Setting Side Only Top',
                page: SettingSidePage()),
          ],
        ));
  }
}
