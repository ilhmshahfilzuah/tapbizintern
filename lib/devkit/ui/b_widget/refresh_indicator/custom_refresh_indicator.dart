...
class CustomRefreshIndicatorPage extends StatefulWidget {
  @override
  _CustomRefreshIndicatorPageState createState() =>
      _CustomRefreshIndicatorPageState();
}

class _CustomRefreshIndicatorPageState
    extends State<CustomRefreshIndicatorPage> {
          ...
          child: ListView(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of refresh indicator with custom color'),
              Container(
