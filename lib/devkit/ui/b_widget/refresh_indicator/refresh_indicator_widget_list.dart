...
import 'package:TapBiz/devkit/ui/b_widget/refresh_indicator/custom_refresh_indicator.dart';
import 'package:TapBiz/devkit/ui/b_widget/refresh_indicator/standart_refresh_indicator.dart';
import 'package:flutter/material.dart';

class RefreshIndicatorWidgetListPage extends StatefulWidget {
  @override
  _RefreshIndicatorWidgetListPageState createState() =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Container(
              child: Text('Refresh Indicator Widget',
                  style: TextStyle(
                      fontSize: 18,
                      color: BLACK21,
                ...
                children: [
                  ...
                  Flexible(
                      ...
                      child: Container(
                          ...
                          child:
                              Icon(Icons.refresh, size: 50, color: SOFT_BLUE)))
                ],
              ),
            ),
            Container(
            ...
            _globalWidget.screenDetailList(
                ...
                page: StandartRefreshIndicatorPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Custom Refresh Indicator',
                page: CustomRefreshIndicatorPage()),
          ],
        ));
  }
}
