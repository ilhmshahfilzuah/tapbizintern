...
class VerticalDirectionWrapPage extends StatefulWidget {
  @override
  _VerticalDirectionWrapPageState createState() =>
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Text('Vertical direction from first row to last row',
              ...
              Container(
                  margin: EdgeInsets.only(top: 10),
                  child: Text('Vertical direction from last row to first row',
                      style: TextStyle(color: SOFT_BLUE))),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: Wrap(
