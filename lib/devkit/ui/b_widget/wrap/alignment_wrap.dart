          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child:
                      Text('Align left', style: TextStyle(color: SOFT_BLUE))),
              Container(
              ...
              Container(
                  ...
                  child:
                      Text('Align center', style: TextStyle(color: SOFT_BLUE))),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: Wrap(
                  spacing: 8,
              ...
              Container(
                  margin: EdgeInsets.only(top: 20),
                  child:
                      Text('Align right', style: TextStyle(color: SOFT_BLUE))),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: Wrap(
                  spacing: 8,
              ...
              Container(
                  margin: EdgeInsets.only(top: 20),
                  child: Text(
                      'Align center & give same space left right at all widget',
              ...
              Container(
                  margin: EdgeInsets.only(top: 20),
                  child: Text(
                      'Align center & give same space between the middle widget',
                      style: TextStyle(color: SOFT_BLUE))),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: Wrap(
              ...
              Container(
                  margin: EdgeInsets.only(top: 20),
                  child: Text('Align center & give same space in every widget',
                      style: TextStyle(color: SOFT_BLUE))),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: Wrap(
