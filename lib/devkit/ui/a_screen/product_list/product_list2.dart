...
import 'package:TapBiz/devkit/model/screen/product_model.dart';
import 'package:TapBiz/devkit/ui/reusable/cache_image_network.dart';
import 'package:TapBiz/devkit/ui/reusable/global_function.dart';
import 'package:TapBiz/devkit/ui/reusable/global_widget.dart';
import 'package:TapBiz/devkit/ui/reusable/shimmer_loading.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:fluttertoast/fluttertoast.dart';

class ProductList2Page extends StatefulWidget {
  @override
  _ProductList2PageState createState() => _ProductList2PageState();
}

class _ProductList2PageState extends State<ProductList2Page> {
  ...
  void _getData() {
    ...
    _productData = [
      ProductModel(
          ...
          price: 18.3,
          image: GLOBAL_URL + "/product/25.jpg",
          rating: 5,
          review: 212,
          sale: 735,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 567,
          image: GLOBAL_URL + "/product/26.jpg",
          rating: 5,
          review: 63,
          sale: 115,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 52,
          image: GLOBAL_URL + "/product/27.jpg",
          rating: 5,
          review: 7,
          sale: 7,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 261,
          image: GLOBAL_URL + "/product/29.jpg",
          rating: 5,
          review: 98,
          sale: 263,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 751,
          image: GLOBAL_URL + "/product/30.jpg",
          rating: 5,
          review: 14,
          sale: 17,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 224.14,
          image: GLOBAL_URL + "/product/31.jpg",
          rating: 5,
          review: 701,
          sale: 1558,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 28.67,
          image: GLOBAL_URL + "/product/32.jpg",
          rating: 5,
          review: 146,
          sale: 398,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 139,
          image: GLOBAL_URL + "/product/33.jpg",
          rating: 5,
          review: 275,
          sale: 1055,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 2.5,
          image: GLOBAL_URL + "/product/34.jpg",
          rating: 5,
          review: 302,
          sale: 752,
          location: "Brooklyn"),
      ...
      ProductModel(
          ...
          price: 10.6,
          image: GLOBAL_URL + "/product/36.jpg",
          rating: 5,
          review: 2802,
          sale: 7052,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 19.9,
          image: GLOBAL_URL + "/product/37.jpg",
          rating: 5,
          review: 105,
          sale: 227,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 2.33,
          image: GLOBAL_URL + "/product/38.jpg",
          rating: 5,
          review: 503,
          sale: 3645,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 5.3,
          image: GLOBAL_URL + "/product/39.jpg",
          rating: 5,
          review: 1095,
          sale: 3400,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 10,
          image: GLOBAL_URL + "/product/40.jpg",
          rating: 5,
          review: 63,
          sale: 131,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 48,
          image: GLOBAL_URL + "/product/41.jpg",
          rating: 5,
          review: 182,
          sale: 427,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 22.66,
          image: GLOBAL_URL + "/product/42.jpg",
          rating: 5,
          review: 131,
          sale: 466,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 2212,
          image: GLOBAL_URL + "/product/43.jpg",
          rating: 5,
          review: 16,
          sale: 37,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 1643,
          image: GLOBAL_URL + "/product/44.jpg",
          rating: 5,
          review: 2,
          sale: 3,
          location: "Brooklyn"),
      ProductModel(
          ...
          price: 9,
          image: GLOBAL_URL + "/product/45.jpg",
          rating: 5,
          review: 30,
          sale: 70,
          location: "Brooklyn"),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                  '(' +
                                      _productData[index].review.toString() +
                                      ')',
                                  style:
                                      TextStyle(fontSize: 11, color: SOFT_GREY))
                            ],
                        ...
                        Container(
                          margin: EdgeInsets.only(top: 5),
                          child: Text(
                              _productData[index].sale.toString() +
                                  ' ' +
                                  'Sale',
