    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        GestureDetector(
          onTap: () {
            Fluttertoast.showToast(
                msg: 'Click verification with email',
        ...
        GestureDetector(
          onTap: () {
            Fluttertoast.showToast(
                msg: 'Click verification with sms',
                toastLength: Toast.LENGTH_SHORT);
          },
          child: Card(
            shape: RoundedRectangleBorder(
        ...
        GestureDetector(
          onTap: () {
            Fluttertoast.showToast(
                msg: 'Click verification with whatsapp',
                toastLength: Toast.LENGTH_SHORT);
          },
          child: Card(
            shape: RoundedRectangleBorder(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Image(
                      image: AssetImage("assets/devkit/images/whatsapp.png"),
                      width: 50,
                      height: 50),
                  Container(
                    margin: EdgeInsets.only(left: 10),
        ...
        Center(
          child: GestureDetector(
            onTap: () {
              Fluttertoast.showToast(
                  msg: 'Click back', toastLength: Toast.LENGTH_SHORT);
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Icon(Icons.arrow_back, size: 16, color: _color1),
                Text(
                  ' Back',
                  style: TextStyle(color: _color1, fontWeight: FontWeight.w700),
                )
              ],
            ),
          ),
