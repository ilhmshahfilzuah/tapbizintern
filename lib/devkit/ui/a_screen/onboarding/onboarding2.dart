...
import 'package:TapBiz/devkit/library/sk_onboarding_screen/sk_onboarding_model.dart';
import 'package:TapBiz/devkit/library/sk_onboarding_screen/sk_onboarding_screen.dart';
...
class _Onboarding2PageState extends State<Onboarding2Page> {
  final pages = [
    SkOnboardingModel(
        ...
        imageAssetPath: 'assets/devkit/images/lamp.jpg'),
    SkOnboardingModel(
        title: 'Tutorial 2',
        description:
