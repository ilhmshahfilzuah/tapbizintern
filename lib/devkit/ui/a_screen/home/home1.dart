...
class _Home1PageState extends State<Home1Page> {
  ...
  void initState() {
    ...
    _categoryData.add(CategoryModel(
        id: 1, name: 'Outlet Store', image: GLOBAL_URL + '/menu/store.png'));
    _categoryData.add(CategoryModel(
        id: 2, name: 'Product', image: GLOBAL_URL + '/menu/products.png'));
    _categoryData.add(CategoryModel(
        id: 3, name: 'Buy Online', image: GLOBAL_URL + '/menu/buy_online.png'));
    _categoryData.add(CategoryModel(
        id: 4,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title: Image.asset('assets/subimages/images/logo_horizontal.png',
