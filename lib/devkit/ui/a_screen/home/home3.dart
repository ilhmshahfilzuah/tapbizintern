...
import 'package:TapBiz/devkit/model/feature/banner_slider_model.dart';
  ...
  void initState() {
    ...
    _trendingData = [
      ProductModel(
        id: 1,
        name: "Adidas Shirt",
        image: GLOBAL_URL + "/product/21.jpg",
        sale: 12700,
      ),
      ProductModel(
        id: 2,
        name: "iPhone SE 2020",
        image: GLOBAL_URL + "/product/22.jpg",
        sale: 8300,
      ),
      ProductModel(
        id: 3,
        name: "Macbook Air 2020",
        image: GLOBAL_URL + "/product/23.jpg",
        sale: 31400,
      ),
      ProductModel(
        id: 4,
        name: "Gaming Chair",
        image: GLOBAL_URL + "/product/24.jpg",
        sale: 11900,
      )
    ];
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text(_trendingData[index].sale.toString() + ' product',
