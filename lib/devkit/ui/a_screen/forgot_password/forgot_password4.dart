...
class _ForgotPassword4PageState extends State<ForgotPassword4Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Center(
            child: Image.asset('assets/devkit/images/logo_horizontal.png',
        ...
        Text(
          ...
          style: TextStyle(fontSize: 14, color: _color3),
        ),
        SizedBox(
          height: 40,
        ),
        TextButton(
            ...
            onPressed: () {
              Fluttertoast.showToast(
                  msg: 'Click reset password', toastLength: Toast.LENGTH_SHORT);
            },
            child: Padding(
        ...
        Center(
          child: GestureDetector(
            onTap: () {
              Fluttertoast.showToast(
                  msg: 'Click back to login', toastLength: Toast.LENGTH_SHORT);
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text(
                  ' Back to login',
                  style:
                      TextStyle(color: _mainColor, fontWeight: FontWeight.w700),
                )
              ],
            ),
          ),
