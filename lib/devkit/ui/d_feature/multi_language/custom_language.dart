...
define all text language at assets/devkit/lang/
...
import 'package:TapBiz/devkit/cubit/language/language_cubit.dart';
import 'package:TapBiz/devkit/ui/d_feature/multi_language/app_localizations.dart';
...
class _CustomLanguagePageState extends State<CustomLanguagePage> {
  ...
  List<String> _languageList = ['English', 'Indonesia', 'Turkic'];
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'Some language is not supported by MaterialLocalizations, so we need to add custom language. In this example, tk language is not supported by MaterialLocalizations.'),
              Container(
                  padding: EdgeInsets.all(16),
                  child: Text(
                      AppLocalizations.of(context)!
                          .translate('text_description')!,
