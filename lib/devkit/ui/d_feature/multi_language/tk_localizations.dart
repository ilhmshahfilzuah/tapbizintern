...
class MaterialLocalizationTkDelegate
...
class MaterialLocalizationTk extends DefaultMaterialLocalizations {
  static MaterialLocalizationTk? of(BuildContext context) {
    return Localizations.of<MaterialLocalizationTk>(
        context, MaterialLocalizationTk);
  }

  Future<bool> load() async {
    // Load the language JSON file from the "lang" folder
    String jsonString =
        await rootBundle.loadString('assets/devkit/lang/tk.json');
