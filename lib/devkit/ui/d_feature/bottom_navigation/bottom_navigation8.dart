...
class BottomNavigation8Page extends StatefulWidget {
  @override
  _BottomNavigation8PageState createState() => _BottomNavigation8PageState();
}

class _BottomNavigation8PageState extends State<BottomNavigation8Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: ConvexAppBar(
        style: TabStyle
            .fixed, // if you are using fixed type, the TabItem must be odd number
