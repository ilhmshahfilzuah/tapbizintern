...
import 'package:TapBiz/devkit/ui/d_feature/bottom_sheet/bottom_sheet1.dart';
import 'package:TapBiz/devkit/ui/d_feature/bottom_sheet/bottom_sheet2.dart';
import 'package:TapBiz/devkit/ui/d_feature/bottom_sheet/bottom_sheet3.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Container(
              child: Text('Bottom Sheet Featured',
                  style: TextStyle(
                      fontSize: 18,
                      color: BLACK21,
              ...
              child: Row(
                children: [
                  Flexible(
                      ...
                      child: Container(
                        child: Text(
                            'Bottom sheet for filtering, menu, choose, etc in application.',
                            style: TextStyle(
                                fontSize: 15,
                                color: BLACK77,
                                letterSpacing: 0.5)),
            ...
            _globalWidget.screenDetailList(
                ...
                page: BottomSheet1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Bottom Sheet for Filter',
                page: BottomSheet2Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Bottom Sheet for Choose',
                page: BottomSheet3Page()),
          ],
        ));
  }
}
