        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(margin: EdgeInsets.only(top: 20), child: Text('2.1')),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: _createRatingBar(rating: 2.1),
              ),
              Container(margin: EdgeInsets.only(top: 20), child: Text('2.4')),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: _createRatingBar(rating: 2.4),
              ),
              Container(margin: EdgeInsets.only(top: 20), child: Text('2.8')),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                child: _createRatingBar(rating: 2.8),
              ),
              Container(margin: EdgeInsets.only(top: 20), child: Text('4.8')),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
