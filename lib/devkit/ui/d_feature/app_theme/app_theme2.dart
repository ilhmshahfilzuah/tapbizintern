    ...
    return Scaffold(
        ...
        body: MaterialApp(
          ...
          theme: theme.copyWith(
            ...
            colorScheme:
                theme.colorScheme.copyWith(secondary: Colors.green[300]),
          ...
          darkTheme: theme.copyWith(
              ...
              colorScheme:
                  theme.colorScheme.copyWith(secondary: Colors.yellow[700]),
          ...
          home: Scaffold(
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    child: Text('App Theme (Custom Theme)',
                        style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Container(
                      child: Text('This is the example of custom theme',
