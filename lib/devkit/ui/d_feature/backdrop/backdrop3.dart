  ...
  Widget build(BuildContext context) {
    return BackdropScaffold(
      ...
      backLayer: BackdropNavigationBackLayer(
        items: [
          ListTile(
              title: Text("Widget 1", style: TextStyle(color: Colors.white))),
          ListTile(
              title: Text("Widget 2", style: TextStyle(color: Colors.white))),
          ListTile(
              title: Text("Widget 3", style: TextStyle(color: Colors.white))),
        ],
