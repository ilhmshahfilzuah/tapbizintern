import 'package:TapBiz/devkit/library/route_transition/rotation_route.dart';
...
class RotationRouteAnimationPage extends StatefulWidget {
  @override
  _RotationRouteAnimationPageState createState() =>
      _RotationRouteAnimationPageState();
}

class _RotationRouteAnimationPageState
    extends State<RotationRouteAnimationPage> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example to create custom page transition (rotation transition).'),
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context, RotationRoute(page: DestinationPage()));
                    }),
              ),
            ],
          ),
