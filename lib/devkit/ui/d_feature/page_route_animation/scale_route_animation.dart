import 'package:TapBiz/devkit/library/route_transition/scale_route.dart';
...
class ScaleRouteAnimationPage extends StatefulWidget {
  @override
  _ScaleRouteAnimationPageState createState() =>
      _ScaleRouteAnimationPageState();
}
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example to create custom page transition (scale transition).'),
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context, ScaleRoute(page: DestinationPage()));
                    }),
              ),
            ],
          ),
