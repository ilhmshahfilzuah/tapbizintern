import 'package:TapBiz/devkit/library/route_transition/combine_route.dart';
...
class CombineRouteAnimationPage extends StatefulWidget {
  @override
  _CombineRouteAnimationPageState createState() =>
      _CombineRouteAnimationPageState();
}
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example to create custom page transition (combine scale and rotate transition).'),
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context, CombineRoute(page: DestinationPage()));
                    }),
              ),
            ],
          ),
