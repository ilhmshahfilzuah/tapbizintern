import 'package:TapBiz/devkit/library/route_transition/fade_route.dart';
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example to create custom page transition (fade transition).'),
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context, FadeRoute(page: DestinationPage()));
                    }),
              ),
            ],
          ),
