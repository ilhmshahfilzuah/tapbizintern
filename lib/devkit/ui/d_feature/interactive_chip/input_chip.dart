        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Wrap(
                    ...
                    children: _emailList.map((value) {
                      return InputChip(
                        ...
                        avatar: CircleAvatar(
                          backgroundImage:
                              NetworkImage(GLOBAL_URL + '/user/avatar.png'),
                        ),
                        label:
              ...
              Container(
                  margin: EdgeInsets.only(top: 20), child: Text('Default')),
              Container(
                ...
                child: InputChip(
                  ...
                  onPressed: () {
                    Fluttertoast.showToast(
                        msg: 'Click input chip',
                        toastLength: Toast.LENGTH_SHORT);
                  },
                ),
              ),
              Container(
                  margin: EdgeInsets.only(top: 20), child: Text('With avatar')),
              Container(
                margin: EdgeInsets.symmetric(vertical: 8),
                // this is the start of example
                child: InputChip(
              ...
              Container(
                ...
                child: InputChip(
                  ...
                  deleteIcon:
                      Icon(Icons.remove_circle, size: 18, color: Colors.white),
                ),
              ),
            ],
          ),
