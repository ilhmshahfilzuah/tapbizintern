            ...
            child: Column(
              ...
              children: [
                _globalWidget.createDetailWidget(
                    ...
                    desc:
                        'This is the example of animated headers with content on Sticky Header'),
                SizedBox(height: 16),
                Column(
                    ...
                    return Container(
                      child: StickyHeaderBuilder(
                        builder: (BuildContext context, double stuckAmount) {
                          ...
                          return Container(
                            height: 50.0,
                            color: Color.lerp(Colors.blue[700],
