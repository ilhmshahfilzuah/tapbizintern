...
import 'package:TapBiz/devkit/ui/d_feature/signature/signature_result.dart';
          ...
          children: [
            Container(
              child: _globalWidget.createDetailWidget(
                  title: 'Signature 1',
                  desc:
                      'This is the example of digital signature 1, write inside the box'),
            ),
            //SIGNATURE CANVAS
            Container(
              ...
              child: Signature(
                ...
                width: MediaQuery.of(context).size.width -
                    50, // 50 is get from left padding 24, right padding 24, and border left and right 2, so total is 50
                height: 400,
                backgroundColor: Colors.white,
              ),
            ),
