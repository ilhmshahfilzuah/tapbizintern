...
import 'package:TapBiz/devkit/ui/d_feature/signature/signature1.dart';
import 'package:TapBiz/devkit/ui/d_feature/signature/signature2.dart';
        ...
        body: ListView(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Flexible(
                      flex: 5,
                      child: Container(
                        child: Text('Digital Signature using different plugin.',
                            style: TextStyle(
                                fontSize: 15,
                                color: BLACK77,
                                letterSpacing: 0.5)),
            ...
            _globalWidget.screenDetailList(
                context: context, title: 'Signature 1', page: Signature1Page()),
            _globalWidget.screenDetailList(
                context: context, title: 'Signature 2', page: Signature2Page()),
          ],
        ));
  }
}
