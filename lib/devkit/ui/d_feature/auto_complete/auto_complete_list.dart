...
import 'package:TapBiz/devkit/ui/d_feature/auto_complete/auto_complete_form.dart';
import 'package:TapBiz/devkit/ui/d_feature/auto_complete/auto_complete_navigation.dart';
        ...
        body: ListView(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Flexible(
                      flex: 5,
                      child: Container(
                        child: Text('Auto complete used to search data.',
                            style: TextStyle(
                                fontSize: 15,
                                color: BLACK77,
                                letterSpacing: 0.5)),
            ...
            _globalWidget.screenDetailList(
                ...
                page: AutoCompleteNavigationPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Auto Complete Form',
                page: AutoCompleteFormPage())
          ],
        ));
  }
}
