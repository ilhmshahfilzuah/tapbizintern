import 'package:TapBiz/devkit/model/feature/product_model.dart';
import 'package:TapBiz/devkit/ui/d_feature/auto_complete/destination.dart';
...
class AutoCompleteNavigationPage extends StatefulWidget {
  @override
  _AutoCompleteNavigationPageState createState() =>
      _AutoCompleteNavigationPageState();
}

class _AutoCompleteNavigationPageState
    extends State<AutoCompleteNavigationPage> {
          ...
          child: Column(
            ...
            children: [
              _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of auto complete with navigation. When you click on the suggestion, it will direct you to the destination page.'),
              Container(
                ...
                child: TypeAheadField(
                  ...
                  itemBuilder: (context, ProductModel suggestion) {
                    return ListTile(
                      ...
                      subtitle: Text('\$ ' +
                          _globalFunction
                              .removeDecimalZeroFormat(suggestion.price)),
                    );
                  },
