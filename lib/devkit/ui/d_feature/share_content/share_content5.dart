...
class ShareContent5Page extends StatefulWidget {
  @override
  _ShareContent5PageState createState() => _ShareContent5PageState();
}

class _ShareContent5PageState extends State<ShareContent5Page> {
          ...
          children: [
            Container(
              child: _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of share image with text & subject'),
            ),
            Stack(
              children: <Widget>[
                                  ...
                                  onPressed: () {
                                    if (kIsWeb) {
                                      Fluttertoast.showToast(
                                          msg:
                                              'share files has not been implemented on Web',
                                          toastLength: Toast.LENGTH_SHORT);
                                    } else {
                                      Share.shareFiles([_selectedFile.path],
                                          text: 'This is text for Images',
                                          subject:
                                              'This is subject for Images');
                                    }
                                  }),
                            )
                          : SizedBox.shrink()
