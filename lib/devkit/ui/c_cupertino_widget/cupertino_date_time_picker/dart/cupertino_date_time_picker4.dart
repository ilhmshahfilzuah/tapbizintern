...
class CupertinoDateTimePicker4Page extends StatefulWidget {
  @override
  _CupertinoDateTimePicker4PageState createState() =>
      _CupertinoDateTimePicker4PageState();
}

class _CupertinoDateTimePicker4PageState
    extends State<CupertinoDateTimePicker4Page> {
          ...
          children: [
            Container(
              child: _globalWidget.createDetailWidget(
                  ...
                  desc:
                      'This is the example of Cupertino Date & Time Picker with dialog'),
            ),
            Container(
                    ...
                    showCupertinoModalPopup<void>(
                      ...
                      builder: (BuildContext context) => CupertinoActionSheet(
                        ...
                        cancelButton: CupertinoActionSheetAction(
                          child: Text('Done'),
                          onPressed: () {
                            final value = DateFormat('MMMM dd, yyyy HH:mm')
                                .format(_dateTime);
