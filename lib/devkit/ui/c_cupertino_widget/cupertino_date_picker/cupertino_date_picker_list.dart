...
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_date_picker/cupertino_date_picker1.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_date_picker/cupertino_date_picker2.dart';
import 'package:flutter/material.dart';

class CupertinoDatePickerListPage extends StatefulWidget {
  @override
  _CupertinoDatePickerListPageState createState() =>
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                ...
                page: CupertinoDatePicker1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Date Picker 2 - with Dialog',
                page: CupertinoDatePicker2Page()),
          ],
        ));
  }
}
