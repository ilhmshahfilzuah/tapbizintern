...
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_switch/cupertino_switch1.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_switch/cupertino_switch2.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_switch/cupertino_switch3.dart';
import 'package:TapBiz/devkit/ui/reusable/global_widget.dart';
import 'package:flutter/material.dart';

class CupertinoSwitchListPage extends StatefulWidget {
  @override
  _CupertinoSwitchListPageState createState() =>
      _CupertinoSwitchListPageState();
}
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                ...
                page: CupertinoSwitch1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Switch 2 - with ListTile',
                page: CupertinoSwitch2Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Switch 3 - Properties',
                page: CupertinoSwitch3Page()),
          ],
        ));
  }
}
