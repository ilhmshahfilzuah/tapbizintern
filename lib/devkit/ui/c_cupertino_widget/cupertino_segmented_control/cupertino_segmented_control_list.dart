...
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_segmented_control/cupertino_segmented_control1.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_segmented_control/cupertino_segmented_control2.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_segmented_control/cupertino_segmented_control3.dart';
...
class CupertinoSegmentedControlListPage extends StatefulWidget {
  @override
  _CupertinoSegmentedControlListPageState createState() =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Container(
              child: Text('Cupertino Segmented Control',
                  style: TextStyle(
                      fontSize: 18,
                      color: BLACK21,
            ...
            _globalWidget.screenDetailList(
                ...
                page: CupertinoSegmentedControl1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Segmented Control 2 - Properties',
                page: CupertinoSegmentedControl2Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Segmented Control 3 - with Map',
                page: CupertinoSegmentedControl3Page()),
          ],
        ));
  }
}
