...
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_timer_picker/cupertino_timer_picker1.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_timer_picker/cupertino_timer_picker2.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_timer_picker/cupertino_timer_picker3.dart';
import 'package:flutter/material.dart';

class CupertinoTimerPickerListPage extends StatefulWidget {
  @override
  _CupertinoTimerPickerListPageState createState() =>
        ...
        body: ListView(
          ...
          children: [
            ...
            _globalWidget.screenDetailList(
                ...
                page: CupertinoTimerPicker1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Timer Picker 2 - Interval',
                page: CupertinoTimerPicker2Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Timer Picker 3 - with Dialog',
                page: CupertinoTimerPicker3Page()),
          ],
        ));
  }
}
