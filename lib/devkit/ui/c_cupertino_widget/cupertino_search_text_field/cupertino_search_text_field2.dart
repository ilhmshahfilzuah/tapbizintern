...
class CupertinoSearchTextField2Page extends StatefulWidget {
  @override
  _CupertinoSearchTextField2PageState createState() =>
      _CupertinoSearchTextField2PageState();
}

class _CupertinoSearchTextField2PageState
    extends State<CupertinoSearchTextField2Page> {
            ...
            children: [
              Container(
                child: _globalWidget.createDetailWidget(
                    ...
                    desc:
                        'This is the example of Cupertino Search Text Field properties'),
              ),
              Container(
                ...
                child: CupertinoSearchTextField(
                  ...
                  placeholder:
                      "Search your product here...", // placeholder text
                  style: TextStyle(color: Colors.white), // search text style
                  placeholderStyle: TextStyle(
                      color: Colors.pinkAccent), // placeholder text style
