...
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_search_text_field/cupertino_search_text_field1.dart';
import 'package:TapBiz/devkit/ui/c_cupertino_widget/cupertino_search_text_field/cupertino_search_text_field2.dart';
...
class CupertinoSearchTextFieldListPage extends StatefulWidget {
  @override
  _CupertinoSearchTextFieldListPageState createState() =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Container(
              child: Text('Cupertino Search Text Field',
                  style: TextStyle(
                      fontSize: 18,
                      color: BLACK21,
                ...
                children: [
                  ...
                  Flexible(
                      ...
                      child: Container(
                          ...
                          child:
                              Icon(Icons.search, size: 50, color: SOFT_BLUE)))
                ],
              ),
            ),
            Container(
            ...
            _globalWidget.screenDetailList(
                ...
                page: CupertinoSearchTextField1Page()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Cupertino Search Text Field 2 - Properties',
                page: CupertinoSearchTextField2Page()),
          ],
        ));
  }
}
