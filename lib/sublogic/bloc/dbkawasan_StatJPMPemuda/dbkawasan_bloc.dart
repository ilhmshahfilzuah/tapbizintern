...
class DbKawasanBloc_StatJPMPemuda extends Bloc<DbKawasanEvent, DbKawasanState> {
  DbKawasanBloc_StatJPMPemuda() : super(InitialDbKawasanState()) {
  ...
  try {
    ...
    String datajson = jsonEncode(data);
      emit(GetDbKawasanSuccess(
        ...
        LogJPM: response.data['LogJPM'],
        LogJPM_Bypinname: response.data['LogJPM_Bypinname'],
