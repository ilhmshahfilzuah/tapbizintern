...
class SplashDevKit extends StatefulWidget {
  const SplashDevKit({super.key});
  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (_) => const SplashDevKit());
  }

  @override
  _SplashDevKitState createState() => _SplashDevKitState();
}

class _SplashDevKitState extends State<SplashDevKit> {
  Timer? _timer;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Container(
        // color: BLACK21,
        child: Center(
          child: Image.asset('${AppSettings.AppLogo}', height: 200),
        ),
      ),
    ));
  }
