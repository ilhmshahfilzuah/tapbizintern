...
class OverBoard extends StatefulWidget {
  ...
  final List<TapBizUIContentModel> pages;
  final Offset? center;
  ...
  OverBoard({Key? key, required this.parentQuery, required this.pages, this.center, this.showBullets, this.skipText, this.nextText, this.finishText, required this.finishCallback, this.animator, this.skipCallback}) : super(key: key);
...
class _OverBoardState extends State<OverBoard> with TickerProviderStateMixin {
                ...
                Row(
                  children: [
                    ...
                    TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, new MaterialPageRoute(builder: (context) => SubSigninPage()));
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 16),
                          child: Text(
                  ...
                  children: [
                    TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, new MaterialPageRoute(builder: (context) => HomePage(tabIndex:2)));
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 16),
                          child: Text(
  ...
  _getPage(index) {
    TapBizUIContentModel page = widget.pages[index];
    return Container(
        width: double.infinity,
        height: double.infinity,
        color: Color(int.parse(page.UIColorBg1)),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            AnimatedBoard(
              ...
              child: new Padding(
                ...
                child: buildCacheNetworkImage(width: 300, height: 300, url: page.UIimageURL, plColor: Colors.transparent),
              ),
            ),
            Padding(
